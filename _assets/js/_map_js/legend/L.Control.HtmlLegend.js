L.Control.HtmlLegend = L.Control.extend({
    ...
    _addElement(html, label, style, container) {
        const row = L.DomUtil.create('span', 'legend-row', container);  // CAMBIAR SPAN POR DIV
...
/*        COMENTADO PARA DESAPARECER ojo DE visibilidad*/
...
/*        COMENTADO PARA DESAPARECER BARRA DE TRANSPARENCIA*/
