...
! function(t) {
    ...
    var i = function(t) {
        ...
        r = L.Class.extend({
            ...
            initialize: function(t) {
                console.log('inizializando componentes');
    ...
    function i(t, e, n) {
        if (n = n || {}, !u(n)) throw new Error("options is invalid");
        var i = n.bbox,
            r = n.id;
        if (t === undefined) throw new Error("geometry is required");
        if (e && e.constructor !== Object) throw new Error("properties must be an Object");
        i && l(i), r && h(r);
        var o = {
            type: "Feature"
        };
        return r && (o.id = r), i && (o.bbox = i), o.properties = e || {}, o.geometry = t, o
    }
    ...
    function o(t, e, n) {
        ...
        for (var r = 0; r < t.length; r++) {
            ...
            for (var s = 0; s < o[o.length - 1].length; s++) {
                if (0 === r && 0 === s && !a(o[0][0]) || !a(o[0][1])) throw new Error("coordinates must contain numbers");
    ...
    function l(t) {
        if (!t) throw new Error("box is required");
        if (!Array.isArray(t)) throw new Error("box must be an Array");
        if (4 !== t.length && 6 !== t.length) throw new Error("box must be an Array of 4 or 6 numbers");
        t.forEach(function(t) {
            if (!a(t)) throw new Error("box must only contain numbers")
        })
    }
    ...
    var i = {
        ...
        _handleSnapping: function(t) {
            ...
            var n, i = t.target,
                r = this._calcClosestLayer(i.getLatLng(), this._snapList),
                o = r.layer instanceof L.Marker || r.layer instanceof L.CircleMarker;
            n = o ? r.latlng : this._checkPrioritiySnapping(r);
            ...
            if (r.distance < s) {
                ...
                var u = this._snapLatLng || {},
                    l = n || {};
                u.lat === l.lat && u.lng === l.lng || (e._snapLatLng = n, i.fire("pm:snap", a), e._layer.fire("pm:snap", a))
            } else this._snapLatLng && (this._unsnap(a), i._snapped = !1, a.marker.fire("pm:unsnap", a), this._layer.fire("pm:unsnap", a));
            return !0
        },
        _checkPrioritiySnapping: function(t) {
            var e, n = this._map,
                ...
                a = this._getDistance(n, r, o),
                u = s < a ? i : r;
            return e = (s < a ? s : a) < this.options.snapDistance ? u : o, Object.assign({}, e)
        },
        ...
        _calcClosestLayer: function(t, e) {
            ...
            return e.forEach(function(e, r) {
                ...
                n.debugIndicatorLines[r].setLatLngs([t, o.latlng]), (i.distance === undefined || o.distance < i.distance) && ((i = o).layer = e)
            }), i
        },
        _calcLayerDistances: function(t, e) {
            var n, i = this,
                r = this._map,
                o = e instanceof L.Polygon,
                s = !(e instanceof L.Polygon) && e instanceof L.Polyline,
                a = e instanceof L.Marker || e instanceof L.CircleMarker,
                u = t;
            if (o) n = e.getLatLngs()[0];
            else if (s) n = e.getLatLngs();
            else if (a) return n = e.getLatLng(), {
                latlng: Object.assign({}, n),
                distance: this._getDistance(r, n, u)
            };
            var l, h;
            n.forEach(function(t, e) {
                var s, a = t;
                s = o ? e + 1 === n.length ? 0 : e + 1 : e + 1 === n.length ? undefined : e + 1;
                var c = n[s];
                if (c) {
                    var p = i._getDistanceToSegment(r, u, a, c);
                    (h === undefined || p < h) && (h = p, l = [a, c])
                }
                return !0
            });
            var c = this._getClosestPointOnSegment(r, t, l[0], l[1]);
            return {
        ...
        _getClosestPointOnSegment: function(t, e, n, i) {
            ...
            var o = t.project(e, r),
                s = t.project(n, r),
                a = t.project(i, r),
                u = L.LineUtil.closestPointOnSegment(o, s, a);
        ...
        _getDistanceToSegment: function(t, e, n, i) {
            ...
            return L.LineUtil.pointToSegmentDistance(r, o, s)
        },
                ...
                for (var n = 0; n < t.length - 1; n++)
                    for (var o = n; o < e.length - 1; o++) {
                        ...
                        var s = function(t, e, n, i, r, o, s, a) {
                            ...
                            return 0 == (u = (a - o) * (n - t) - (s - r) * (i - e)) ? null !== f.x && null !== f.y && f : (l = e - o, h = t - r, c = (s - r) * l - (a - o) * h, p = (n - t) * l - (i - e) * h, l = c / u, h = p / u, f.x = t + l * (n - t), f.y = e + l * (i - e), l >= 0 && l <= 1 && (f.onLine1 = !0), h >= 0 && h <= 1 && (f.onLine2 = !0), !(!f.onLine1 || !f.onLine2) && [f.x, f.y])
                        }(t[n][0], t[n][1], t[n + 1][0], t[n + 1][1], e[o][0], e[o][1], e[o + 1][0], e[o + 1][1]);
                        s && r.features.push(Object(i.e)([s[0], s[1]]))
                    }
            })
        }), r
    }
    ...
    Object.defineProperty(e, "__esModule", {
        ...
        millimetres: 1e6,
        yards: 1.195990046
    }, e.feature = i, e.geometry = function(t, e, n) {
        switch (void 0 === n && (n = {}), t) {
            case "Point":
                return r(e).geometry;
            case "LineString":
    ...
    }, e.lineString = s, e.lineStrings = function(t, e, n) {
        return void 0 === n && (n = {}), a(t.map(function(t) {
            return s(t, e)
        }), n)
    }, e.featureCollection = a, e.multiLineString = u, e.multiPoint = l, e.multiPolygon = h, e.geometryCollection = function(t, e, n) {
        return void 0 === n && (n = {}), i({
        ...
        return t / r * o
    }, e.isNumber = g, e.isObject = function(t) {
        return !!t && t.constructor === Object
        ...
        t.forEach(function(t) {
            if (!g(t)) throw new Error("bbox must only contain numbers")
        })
    ...
    function i(t, e) {
        var n, i, r, o, s, a, u, l, h, c, p = 0,
            f = "FeatureCollection" === t.type,
            g = "Feature" === t.type,
            d = f ? t.features.length : 1;
        for (n = 0; n < d; n++) {
            for (a = f ? t.features[n].geometry : g ? t.geometry : t, l = f ? t.features[n].properties : g ? t.properties : {}, h = f ? t.features[n].bbox : g ? t.bbox : undefined, c = f ? t.features[n].id : g ? t.id : undefined, s = (u = !!a && "GeometryCollection" === a.type) ? a.geometries.length : 1, r = 0; r < s; r++)
                if (null !== (o = u ? a.geometries[r] : a)) switch (o.type) {
                        case "Point":
                        case "LineString":
                        case "MultiPoint":
                        case "Polygon":
                        case "MultiLineString":
                        case "MultiPolygon":
                            if (!1 === e(o, p, l, h, c)) return !1;
                            break;
                        case "GeometryCollection":
                            for (i = 0; i < o.geometries.length; i++)
                                if (!1 === e(o.geometries[i], p, l, h, c)) return !1;
                            break;
                        default:
                            throw new Error("Unknown Geometry Type")
                    } else if (!1 === e(null, p, l, h, c)) return !1;
            p++
        }
    }
    ...
    function r(t, e, n) {
        ...
        return i(t, function(t, i, o, s, a) {
            r = 0 === i && n === undefined ? t : e(r, t, i, o, s, a)
        }), r
    }

    function o(t, e) {
        i(t, function(t, n, i, r, o) {
            ...
            for (var l = 0; l < t.coordinates.length; l++) {
                ...
                if (!1 === e(Object(s.a)(h, i), n, l)) return !1
            }
        })
    }
    n.d(e, "b", function() {
    ...
    var i = L.Class.extend({
        ...
        removeLayer: function(t) {
            // Preguntar si se quiere eliminar el marcador
            var e = t.target;
            var coor_marcas;
            if (e._latlng) {
                coor_marcas = e._latlng;
            } else if (e._latlngs) {
                coor_marcas = e._latlngs[0];
            }
            bootbox.confirm({
                title: "Desea eliminar la marca?",
                message: "Esta a punto de eliminar esta marca",
                buttons: {
                    confirm: {
                        label: 'Elminiar',
                ...
                callback: (result) => {
                    if (result == true) {
                        let deleteMarker = (cor) => {
                            $.ajax({
                                type: "post",
                                url: "Mapa/deleteMarkers",
                                data: {
                                    "coordenadas": cor,
                                ...
                                error: function(xhr) {
                                    console.log(xhr);
                                    if (xhr.status == 500) {
                                        toastr.error("Si el problema perciste comunicate con el administrador", "Error interno, intentalo mas tarde", {
                                            "positionClass": "toast-bottom-center",
                                            "showDuration": "250",
                                            "hideDuration": "1000",
                                            "timeOut": "5000",
                        ...
                        deleteMarker(JSON.stringify(coor_marcas));
                    }
                }
            });
        },
        ...
        toggleGlobalEditMode: function(t) {
            console.log("toggle global edit mode", t), this.globalEditEnabled() ? this.disableGlobalEditMode() : this.enableGlobalEditMode(t)
        }
    });
    e["default"] = i
}, function(t, e, n) {
    ...
    var r = L.Class.extend({
        ...
        addControls: function() {
            ...
            "undefined" != typeof t.editPolygon && (t.editMode = t.editPolygon), "undefined" != typeof t.deleteLayer && (t.removalMode = t.deleteLayer), L.Util.setOptions(this, t), this._showHideButtons(), this.isVisible = !0
        },
        removeControls: function() {
        ...
        _defineButtons: function() {
            ...
            this._addButton("drawMarker", new L.Control.PMButton(r)), this._addButton("drawPolyline", new L.Control.PMButton(o)), this._addButton("drawRectangle", new L.Control.PMButton(a)), this._addButton("drawPolygon", new L.Control.PMButton(n)), this._addButton("drawCircle", new L.Control.PMButton(s)), this._addButton("cutPolygon", new L.Control.PMButton(i)), this._addButton("editMode", new L.Control.PMButton(u)), this._addButton("dragPolygon", new L.Control.PMButton(l)), this._addButton("removalMode", new L.Control.PMButton(e))
        },
    ...
    var i = L.Control.extend({
        ...
        onAdd: function(t) {
            //Aqui se agregan al div
            var elemento = document.getElementById('herramientas_map');
            return  this._map = t, this._container = this._map.pm.Toolbar.container, this.buttonsDomNode = this._makeButton(this._button), elemento.appendChild(this.buttonsDomNode), this._container
        ...
        _makeButton: function(t) {
            //Aqui se hace la funcion para dibujar
            var e = this,
            ...
            return t.iconUrl && i.setAttribute("src", t.iconUrl), t.className && L.DomUtil.addClass(i, t.className), L.DomEvent.addListener(n, "click", function() {
                // Al dar click en algun boton de dibujar
    ...
    i["default"].Marker = i["default"].extend({
        initialize: function(t) {
        ...
        _createMarker: function(t) {
            if (t.latlng) {
                ...
                // Promp para ingresar leyenda de marcador
                bootbox.prompt({
                    title: "Ingrese descripcion para marcador: ",
                    buttons: {
                        cancel: {
                            ...
                            let saveMarker = (cor) => {
                                $.ajax({
                                    ...
                                    success: (respuesta) => {
                                        var json = JSON.parse(respuesta);
                                        if (json.status == "ok") {
                                            // Activa el switch al momento de usar un marcador
                                            document.getElementById("myCheck1").checked = true;
                                            n.addTo(this._map).bindPopup(leyendaM), n.pm.enable(), this._map.fire("pm:create", {
                                                shape: this._shape,
                                                marker: n,
                                                layer: n
    ...
    var r = i(n(4)),
        o = i(n(0));
    o["default"].Line = o["default"].extend({
        initialize: function(t) {
        ...
        hasSelfIntersection: function() {
            return (0, r["default"])(this._layer.toGeoJSON()).features.length > 0
        },
    ...
    i["default"].Poly = i["default"].Line.extend({
        initialize: function(t) {
            this._map = t, this._shape = "Poly", this.toolbarButtonName = "drawPolygon"
        },
        _finishShape: function(t) {
            if (this.options.allowSelfIntersection || !this._doesSelfIntersect) {
                // Promp para ingresar leyenda de poligono
                bootbox.prompt({
                    title: "Ingrese descripcion para poligono: ",
                    buttons: {
                        cancel: {
                            label: '<i class="fa fa-times"></i> Cancelar'
                        },
                            ...
                            let savePoligon = (cor) => {
                                $.ajax({
                                    ...
                                    success: (respuesta) => {
                                        var json = JSON.parse(respuesta);
                                        if (json.status == "ok") {
                                            var n = L.polygon(e, this.options.pathOptions).addTo(this._map).bindPopup(leyendaP);
                                            toastr.success("", json.msg, {
                                                "positionClass": "toast-bottom-center",
                                                "showDuration": "250",
                                                "hideDuration": "1000",
    ...
    i["default"].Rectangle = i["default"].extend({
        initialize: function(t) {
    ...
    i["default"].Circle = i["default"].extend({
        initialize: function(t) {
    ...
    s["default"].Cut = s["default"].Poly.extend({
        ...
        _cut: function(t) {
            ...
            Object.keys(n).map(function(t) {
                ...
                try {
                    return !!(0, r["default"])(t.toGeoJSON(), e.toGeoJSON())
                } catch (n) {
                    return console.error("You cant cut polygons with self-intersections"), !1
                }
            }).forEach(function(n) {
                var r = (0, o["default"])(n.toGeoJSON(), t.toGeoJSON());
                if ("MultiPolygon" === r.geometry.type) {
                    r.geometry.coordinates.reduce(function(t, e) {
                        return t.push({
                            type: "Polygon",
                            coordinates: e
                        }), t
                    }, []).forEach(function(t) {
                        var r = L.geoJSON(t, n.options);
                        i.push(r), r.addTo(e._map), r.pm.enable(e.options), r.pm.disable()
                    })
                } else {
                    var s = L.geoJSON(r, n.options).addTo(e._map);
    ...
    function i(t, e, n) {
        ...
        var r = s.getGeom(t),
            u = s.getGeom(e);
        if ("Polygon" === r.type && "Polygon" === u.type) {
            var l = a.intersection(r.coordinates, u.coordinates);
            if (null === l || 0 === l.length) return null;
            if (1 === l.length) {
                var h = l[0][0][0],
                    c = l[0][0][l[0][0].length - 1];
                return h[0] === c[0] && h[1] === c[1] ? o.polygon(l[0], n.properties) : null
            }
            return o.multiPolygon(l, n.properties)
        }
        if ("MultiPolygon" === r.type) {
            for (var p = [], f = 0, g = r.coordinates; f < g.length; f++) {
                var d = g[f],
                    _ = i(s.getGeom(o.polygon(d)), u);
                if (_) {
                    var y = s.getGeom(_);
                    if ("Polygon" === y.type) p.push(y.coordinates);
                    else {
                        if ("MultiPolygon" !== y.type) throw new Error("intersection is invalid");
                        p = p.concat(y.coordinates)
                    }
                }
            }
            return 0 === p.length ? null : 1 === p.length ? o.polygon(p[0], n.properties) : o.multiPolygon(p, n.properties)
        }
        if ("MultiPolygon" === u.type) return i(u, r);
    ...
    function i(t) {
        if (t.length > 1 && Object(r.isNumber)(t[0]) && Object(r.isNumber)(t[1])) return !0;
    ...
    Object.defineProperty(e, "__esModule", {
        ...
        if (Array.isArray(t) && t.length >= 2 && t[0].length === undefined && t[1].length === undefined) return t;
    ...
    }, e.containsNumber = i, e.geojsonType = function(t, e, n) {
        ...
        if (t.geometry !== undefined) return t.geometry;
    ...
    ! function(e) {
        ...
        return function t(e, n, r) {
            ...
            2: [function(t, e, n) {
                ! function(t, i) {
                    "object" == typeof n && void 0 !== e ? e.exports = i() : t.avl = i()
                }(this, function() {
                    "use strict";
                    ...
                    function t(e, n, i, r, o) {
                        if (e) {
                            r(n + (i ? "└── " : "├── ") + o(e) + "\n");
                            var s = n + (i ? "    " : "│   ");
                            e.left && t(e.left, s, !1, r, o), e.right && t(e.right, s, !0, r, o)
                        }
                    }
                    ...
                    function e(t) {
                        ...
                        var i = n(t.left),
                            r = n(t.right);
                        return !!(Math.abs(i - r) <= 1 && e(t.left) && e(t.right))
                    }

                    function n(t) {
                        return t ? 1 + Math.max(n(t.left), n(t.right)) : 0
                    }
                    ...
                    var o = function(t, e) {
                            void 0 === e && (e = !1), this._comparator = t || function(t, e) {
                                return t > e ? 1 : t < e ? -1 : 0
                            }, this._root = null, this._size = 0, this._noDuplicates = !!e
                        },
                        s = {
                            size: {}
                        };
                    return o.prototype.destroy = function() {
                        ...
                        for (var e = this._root, n = [], i = !1, r = 0; !i;) e ? (n.push(e), e = e.left) : n.length > 0 ? (t(e = n.pop(), r++), e = e.right) : i = !0;
                        return this
                        ...
                        for (var e = this._root, n = [], i = !1, r = 0; !i;)
                            if (e) n.push(e), e = e.left;
                            else if (n.length > 0) {
                            if (e = n.pop(), r === t) return e;
                            r++, e = e.right
                        } else i = !0;
                        return null
                    }, o.prototype.minNode = function() {
                        var t = this._root;
                        if (!t) return null;
                        for (; t.left;) t = t.left;
                        return t
                    }, o.prototype.maxNode = function() {
                        var t = this._root;
                        if (!t) return null;
                        ...
                        if (this._noDuplicates)
                            for (; s;) {
                                if (u = o(t, s.key), a = s, 0 === u) return null;
                                s = u < 0 ? s.left : s.right
                            } else
                                for (; s;) a = s, s = (u = o(t, s.key)) <= 0 ? s.left : s.right;
                        var l, h = {
                            left: null,
                            right: null,
                            balanceFactor: 0,
                        ...
                        for (u <= 0 ? a.left = h : a.right = h; a && ((u = o(a.key, t)) < 0 ? a.balanceFactor -= 1 : a.balanceFactor += 1, 0 !== a.balanceFactor);) {
                            if (a.balanceFactor < -1) {
                                1 === a.right.balanceFactor && r(a.right), l = i(a), a === n._root && (n._root = l);
                                break
                            }
                            if (a.balanceFactor > 1) {
                                -1 === a.left.balanceFactor && i(a.left), l = r(a), a === n._root && (n._root = l);
                                break
                            }
                            a = a.parent
                        }
                        ...
                        for (var n = this._root, o = this._comparator, s = 0; n && 0 !== (s = o(t, n.key));) n = s < 0 ? n.left : n.right;
                        if (!n) return null;
                        var a, u, l = n.key;
                        if (n.left) {
                            for (a = n.left; a.left || a.right;) {
                                for (; a.right;) a = a.right;
                                n.key = a.key, n.data = a.data, a.left && (n = a, a = a.left)
                            }
                            n.key = a.key, n.data = a.data, n = a
                        }
                        if (n.right) {
                            for (u = n.right; u.left || u.right;) {
                                for (; u.left;) u = u.left;
                                n.key = u.key, n.data = u.data, u.right && (n = u, u = u.right)
                            }
                            n.key = u.key, n.data = u.data, n = u
                        }
                        for (var h, c = n.parent, p = n; c && (c.left === p ? c.balanceFactor -= 1 : c.balanceFactor += 1, c.balanceFactor < -1 ? (1 === c.right.balanceFactor && r(c.right), h = i(c), c === e._root && (e._root = h), c = h) : c.balanceFactor > 1 && (-1 === c.left.balanceFactor && i(c.left), h = r(c), c === e._root && (e._root = h), c = h), -1 !== c.balanceFactor && 1 !== c.balanceFactor);) p = c, c = c.parent;
                        return n.parent && (n.parent.left === n ? n.parent.left = null : n.parent.right = null), n === this._root && (this._root = null), this._size--, l
                    }, o.prototype.load = function(t, e) {
                        var n = this;
                        if (void 0 === t && (t = []), void 0 === e && (e = []), Array.isArray(t))
                            for (var i = 0, r = t.length; i < r; i++) n.insert(t[i], e[i]);
                        return this
                    }, o.prototype.isBalanced = function() {
                        return e(this._root)
                        ...
                        return function(e, n) {
                            ...
                            var i = [];
                            return t(e, "", !0, function(t) {
                                return i.push(t)
                            }, n), i.join("")
                        }(this._root, e)
                    }, Object.defineProperties(o.prototype, s), o
                })
            }, {}],
            3: [function(t, e, n) {
                "use strict";
            ...
            5: [function(t, e, n) {
                ...
                e.exports = function(t, e) {
                    if (t === e) return 0;
                    if (0 !== i(t.point, t.otherEvent.point, e.point) || 0 !== i(t.point, t.otherEvent.point, e.otherEvent.point)) return o(t.point, e.point) ? t.isBelow(e.otherEvent.point) ? -1 : 1 : t.point[0] === e.point[0] ? t.point[1] < e.point[1] ? -1 : 1 : 1 === r(t, e) ? e.isAbove(t.point) ? -1 : 1 : t.isBelow(e.point) ? -1 : 1;
                    if (t.isSubject !== e.isSubject) return t.isSubject ? -1 : 1;
                    var n = t.point,
                        s = e.point;
                    return n[0] === s[0] && n[1] === s[1] ? (n = t.otherEvent.point, s = e.otherEvent.point, n[0] === s[0] && n[1] === s[1] ? 0 : t.contourId > e.contourId ? 1 : -1) : 1 === r(t, e) ? 1 : -1
                }
            }, {
                "./compare_events": 4,
                "./equals": 10,
                ...
                function i(t, e) {
                    switch (t.type) {
                        case r.NORMAL:
                            ...
                            break;
                        case r.SAME_TRANSITION:
                            return e === s || e === a;
                        case r.DIFFERENT_TRANSITION:
                            return e === u;
                        case r.NON_CONTRIBUTING:
                            return !1
                    }
                    return !1
                }
            ...
            7: [function(t, e, n) {
                ...
                function i(t, e, n, i) {
                    var r = t + 1,
                        o = e.length;
                    if (r > o - 1) return t - 1;
                    for (var s = e[t].point, a = e[r].point; r < o && a[0] === s[0] && a[1] === s[1];) {
                        if (!n[r]) return r;
                        a = e[++r].point
                    }
                    for (r = t - 1; n[r] && r >= i;) r--;
                ...
                var r = t("./compare_events"),
                    o = t("./operation");
                e.exports = function(t, e) {
                    var n, s, a, u = function(t) {
                            var e, n, i, o, s = [];
                            for (n = 0, i = t.length; n < i; n++)((e = t[n]).left && e.inResult || !e.left && e.otherEvent.inResult) && s.push(e);
                            for (var a = !1; !a;)
                                for (a = !0, n = 0, i = s.length; n < i; n++) n + 1 < i && 1 === r(s[n], s[n + 1]) && (o = s[n], s[n] = s[n + 1], s[n + 1] = o, a = !1);
                            for (n = 0, i = s.length; n < i; n++)(e = s[n]).pos = n, e.left || (o = e.pos, e.pos = e.otherEvent.pos, e.otherEvent.pos = o);
                            return s
                        }(t),
                        l = {},
                        h = [];
                    for (n = 0, s = u.length; n < s; n++)
                        if (!l[n]) {
                            ...
                            u[n].isExteriorRing ? e === o.DIFFERENCE && !u[n].isSubject && h.length > 1 ? h[h.length - 1].push(c[0]) : h.push(c) : e !== o.DIFFERENCE || u[n].isSubject || 0 !== h.length ? 0 === h.length ? h.push([
                                [c]
                            ]) : h[h.length - 1].push(c[0]) : h.push(c);
                            var p = h.length - 1,
                                f = n,
                                g = u[n].point;
                            for (c[0].push(g); f >= n;) a = u[f], l[f] = !0, a.left ? (a.resultInOut = !1, a.contourId = p) : (a.otherEvent.resultInOut = !0, a.otherEvent.contourId = p), l[f = a.pos] = !0, c[0].push(u[f].point), f = i(f, u, l, n);
                            a = u[f = -1 === f ? n : f], l[f] = l[a.pos] = !0, a.otherEvent.resultInOut = !0, a.otherEvent.contourId = p
                        }
                    return h
                }
            }, {
            ...
            8: [function(t, e, n) {
                ...
                e.exports = function(t, e, n) {
                    ...
                    return r(t.point, t.otherEvent.point) && console.warn("what is that, a collapsed segment?", t), s.contourId = a.contourId = t.contourId, o(a, t.otherEvent) > 0 && (t.otherEvent.left = !0, a.left = !1), t.otherEvent.otherEvent = a, t.otherEvent = s, n.push(a), n.push(s), n
                }
            }, {
                "./compare_events": 4,
                "./equals": 10,
            ...
            11: [function(t, e, n) {
                ...
                function i(t, e, n, i, r, a) {
                    ...
                    for (h = 0, c = t.length - 1; h < c; h++)
                        if (p = t[h], f = t[h + 1], g = new o(p, !1, undefined, e), d = new o(f, !1, g, e), g.otherEvent = d, p[0] !== f[0] || p[1] !== f[1]) {
                            g.contourId = d.contourId = n, a || (g.isExteriorRing = !1, d.isExteriorRing = !1), s(g, d) > 0 ? d.left = !0 : g.left = !0;
                            var _ = p[0],
                                y = p[1];
                            r[0] = l(r[0], _), r[1] = l(r[1], y), r[2] = u(r[2], _), r[3] = u(r[3], y), i.push(g), i.push(d)
                        }
                }
                var r = t("tinyqueue"),
                    o = t("./sweep_event"),
                    ...
                    l = Math.min,
                    h = 0;
                e.exports = function(t, e, n, o, u) {
                    var l, c, p, f, g, d, _ = new r(null, s);
                    for (p = 0, f = t.length; p < f; p++)
                        for (g = 0, d = (l = t[p]).length; g < d; g++)(c = 0 === g) && h++, i(l[g], !0, h, _, n, c);
                    for (p = 0, f = e.length; p < f; p++)
                        for (g = 0, d = (l = e[p]).length; g < d; g++) c = 0 === g, u === a.DIFFERENCE && (c = !1), c && h++, i(l[g], !1, h, _, o, c);
                    return _
                }
            }, {
                "./compare_events": 4,
            ...
            12: [function(t, e, n) {
                ...
                function i(t, e, n) {
                    ...
                    var i = function(t, e, n) {
                        var i = null;
                        return t.length * e.length == 0 && (n === a.INTERSECTION ? i = u : n === a.DIFFERENCE ? i = t : n !== a.UNION && n !== a.XOR || (i = 0 === t.length ? e : t)), i
                    }(t, e, n);
                    if (i) return i === u ? null : i;
                    var l = [Infinity, Infinity, -Infinity, -Infinity],
                        h = [Infinity, Infinity, -Infinity, -Infinity],
                        c = s(t, e, l, h, n);
                    if (i = function(t, e, n, i, r) {
                            var o = null;
                            return (n[0] > i[2] || i[0] > n[2] || n[1] > i[3] || i[1] > n[3]) && (r === a.INTERSECTION ? o = u : r === a.DIFFERENCE ? o = t : r !== a.UNION && r !== a.XOR || (o = t.concat(e))), o
                        }(t, e, l, h, n)) return i === u ? null : i;
                    var p = r(c, t, e, l, h, n);
                    return o(p, n)
                }
                var r = t("./subdivide_segments"),
                    o = t("./connect_edges"),
                    s = t("./fill_queue"),
                    a = t("./operation"),
                    u = [];
            ...
            14: [function(t, e, n) {
                ...
                var i = t("./divide_segment"),
                    r = t("./segment_intersection"),
                    o = t("./equals"),
                    s = t("./compare_events"),
                    a = t("./edge_type");
                e.exports = function(t, e, n) {
                    var u = r(t.point, t.otherEvent.point, e.point, e.otherEvent.point),
                        l = u ? u.length : 0;
                    if (0 === l) return 0;
                    if (1 === l && (o(t.point, e.point) || o(t.otherEvent.point, e.otherEvent.point))) return 0;
                    if (2 === l && t.isSubject === e.isSubject) return 0;
                    if (1 === l) return o(t.point, u[0]) || o(t.otherEvent.point, u[0]) || i(t, u[0], n), o(e.point, u[0]) || o(e.otherEvent.point, u[0]) || i(e, u[0], n), 1;
                    var h = [],
                        c = !1,
                        p = !1;
                    return o(t.point, e.point) ? c = !0 : 1 === s(t, e) ? h.push(e, t) : h.push(t, e), o(t.otherEvent.point, e.otherEvent.point) ? p = !0 : 1 === s(t.otherEvent, e.otherEvent) ? h.push(e.otherEvent, t.otherEvent) : h.push(t.otherEvent, e.otherEvent), c && p || c ? (e.type = a.NON_CONTRIBUTING, t.type = e.inOut === t.inOut ? a.SAME_TRANSITION : a.DIFFERENT_TRANSITION, c && !p && i(h[1].otherEvent, h[0].point, n), 2) : p ? (i(h[0], h[1].point, n), 3) : h[0] !== h[3].otherEvent ? (i(h[0], h[1].point, n), i(h[1], h[2].point, n), 3) : (i(h[0], h[1].point, n), i(h[3].otherEvent, h[2].point, n), 3)
                }
            }, {
                "./compare_events": 4,
                "./divide_segment": 8,
            ...
            15: [function(t, e, n) {
                ...
                e.exports = function(t, e, n, o, s) {
                    ...
                    if (p > 1e-9 * f * r(l, l)) {
                        ...
                        var d = i(h, u) / c;
                        return d < 0 || d > 1 ? null : s ? null : [a(t, g, u)]
                    }
                    var _ = r(h, h);
                    if (c = i(h, u), (p = c * c) > 1e-9 * f * _) return null;
                    var y = r(u, h) / f,
                        m = y + r(u, l) / f,
                        v = Math.min(y, m),
                        E = Math.max(y, m);
                    return v <= 1 && E >= 0 ? 1 === v ? s ? null : [a(t, v > 0 ? v : 0, u)] : 0 === E ? s ? null : [a(t, E < 1 ? E : 1, u)] : s && 0 === v && 1 === E ? null : [a(t, v > 0 ? v : 0, u), a(t, E < 1 ? E : 1, u)] : null
                }
            }, {}],
            16: [function(t, e, n) {
                "use strict";
            ...
            17: [function(t, e, n) {
                ...
                var i = t("avl"),
                    r = t("./compute_fields"),
                    o = t("./possible_intersection"),
                    s = t("./compare_segments"),
                    a = t("./operation");
                e.exports = function(t, e, n, u, l, h) {
                    for (var c, p, f, g = new i(s), d = [], _ = Math.min(u[2], l[2]), y = a.INTERSECTION, m = a.DIFFERENCE; t.length;) {
                        var v = t.pop();
                        if (d.push(v), h === y && v.point[0] > _ || h === m && v.point[0] > u[2]) break;
                        if (v.left) {
                            p = c = g.insert(v), c = c !== (f = g.minNode()) ? g.prev(c) : null, p = g.next(p);
                            var E, I = c ? c.key : null;
                            if (r(v, I, h), p && 2 === o(v, p.key, t) && (r(v, I, h), r(v, p.key, h)), c && 2 === o(c.key, v, t)) {
                                var L = c;
                                E = (L = L !== f ? g.prev(L) : null) ? L.key : null, r(I, E, h), r(v, I, h)
                            }
                        } else v = v.otherEvent, p = c = g.find(v), c && p && (c = c !== f ? g.prev(c) : null, p = g.next(p), g.remove(v), p && c && o(c.key, p.key, t))
                    }
                    return d
                }
            }, {
            ...
            18: [function(t, e, n) {
                ...
                function i(t, e, n, i, o) {
                    this.left = e, this.point = t, this.otherEvent = n, this.isSubject = i, this.type = o || r.NORMAL, this.inOut = !1, this.otherInOut = !1, this.prevInResult = null, this.inResult = !1, this.resultInOut = !1, this.isExteriorRing = !0
                }
                var r = t("./edge_type");
                i.prototype = {
                    isBelow: function(t) {
    ...
    function i(t) {
        switch (t.type) {
            case "Polygon":
                return Object(o.a)(t) > 1 ? t : null;
            case "MultiPolygon":
                var e = [];
                if (Object(u.a)(t, function(t) {
                        Object(o.a)(t) > 1 && e.push(t.geometry.coordinates)
                    }), e.length) return {
                    type: "MultiPolygon",
                    coordinates: e
                }
    ...
    e["default"] = function(t, e) {
        var n = Object(a.a)(t),
            o = Object(a.a)(e),
            u = t.properties || {};
        if (n = i(n), o = i(o), !n) return null;
        if (!o) return Object(s.a)(n, u);
        var l = new r.GeoJSONReader,
            h = l.read(n),
            c = l.read(o),
            p = r.OverlayOp.difference(h, c);
        if (p.isEmpty()) return null;
        var f = (new r.GeoJSONWriter).write(p);
        return Object(s.a)(f, u)
    }
}, function(t, e, n) {
    ! function(t, n) {
        n(e)
        ...
        function f() {
            this.array_ = [], arguments[0] instanceof Et && this.addAll(arguments[0])
        }
        ...
        y.prototype.interfaces_ = function() {
            ...
            return y
        }, y.prototype.equalsWithTolerance = function(t, e, n) {
        ...
        var I = function() {},
            ...
            x = function() {},
            N = function kr() {
                if (this.x = null, this.y = null, this.z = null, 0 === arguments.length) this.x = 0, this.y = 0, this.z = kr.NULL_ORDINATE;
                else if (1 === arguments.length) {
                    var t = arguments[0];
                    this.x = t.x, this.y = t.y, this.z = t.z
                } else 2 === arguments.length ? (this.x = arguments[0], this.y = arguments[1], this.z = kr.NULL_ORDINATE) : 3 === arguments.length && (this.x = arguments[0], this.y = arguments[1], this.z = arguments[2])
            },
            b = {
        ...
        N.prototype.setOrdinate = function(t, e) {
            ...
            if (2 === arguments.length) {
                var e = arguments[0],
                    n = arguments[1];
                return !!y.equalsWithTolerance(this.x, e.x, n) && !!y.equalsWithTolerance(this.y, e.y, n)
            }
            ...
            return y.equalsWithTolerance(this.z, t.z, e)
            ...
            var t = 17;
            return t = 37 * t + N.hashCode(this.x), t = 37 * t + N.hashCode(this.y)
        ...
        }, b.DimensionalComparator.get = function() {
            return C
        }, b.serialVersionUID.get = function() {
            return 0x5cbf2c235c7e5800
        }, b.NULL_ORDINATE.get = function() {
            return v.NaN
        }, b.X.get = function() {
            return 0
        }, b.Y.get = function() {
        ...
        C.prototype.compare = function(t, e) {
            ...
            return 0 !== o ? o : this._dimensionsToTest <= 2 ? 0 : C.compare(n.z, i.z)
        ...
        }, M.INTERIOR.get = function() {
            return 0
        }, M.BOUNDARY.get = function() {
            return 1
        }, M.EXTERIOR.get = function() {
            return 2
        }, M.NONE.get = function() {
            return -1
        ...
        k.prototype.le = function(t) {
            ...
            var n = this.abs(),
                i = k.magnitude(n._hi),
                r = k.TEN.pow(i);
            (n = n.divide(r)).gt(k.TEN) ? (n = n.divide(k.TEN), i += 1) : n.lt(k.ONE) && (n = n.multiply(k.TEN), i -= 1);
            for (var o = i + 1, s = new R, a = k.MAX_PRINT_DIGITS - 1, u = 0; u <= a; u++) {
                t && u === o && s.append(".");
                var l = Math.trunc(n._hi);
                if (l < 0) break;
                var h = !1,
                    c = 0;
                l > 9 ? (h = !0, c = "9") : c = "0" + l, s.append(c), n = n.subtract(k.valueOf(l)).multiply(k.TEN), h && n.selfAdd(k.TEN);
                var p = !0,
                    f = k.magnitude(n._hi);
            ...
            if (1 === arguments.length) {
                ...
                var n = arguments[0],
                    ...
                    h = null,
                    c = null;
                return u = this._hi / n, l = k.SPLIT * u, r = l - u, c = k.SPLIT * n, r = l - r, o = u - r, s = c - n, h = u * n, s = c - s, a = n - s, c = r * s - h + r * a + o * s + o * a, l = (this._hi - h - c + this._lo - u * i) / n, c = u + l, this._hi = c, this._lo = u - c + l, this
            }
            ...
            if (arguments[0] instanceof k) {
                var t = arguments[0],
                    ...
                    a = null,
                    u = null;
                return n = (o = this._hi / t._hi) - (e = (s = k.SPLIT * o) - (e = s - o)), u = e * (i = (u = k.SPLIT * t._hi) - (i = u - t._hi)) - (a = o * t._hi) + e * (r = t._hi - i) + n * i + n * r, s = (this._hi - a - u + this._lo - o * t._lo) / t._hi, new k(u = o + s, o - u + s)
            }
            if ("number" == typeof arguments[0]) {
                var l = arguments[0];
                return v.isNaN(l) ? k.createNaN() : k.copy(this).selfDivide(l, 0)
            }
            ...
            if (1 === arguments.length) {
                ...
                var u = arguments[0],
                    ...
                    d = null,
                    _ = null;
                f = this._hi + u, c = this._lo + l, g = f - (d = f - this._hi), p = c - (_ = c - this._lo);
                var y = (h = f + (d = (g = u - d + (this._hi - g)) + c)) + (d = (p = l - _ + (this._lo - p)) + (d + (f - h))),
                    m = d + (h - y);
            ...
            if (1 === arguments.length) {
                ...
                var n = arguments[0],
                    ...
                    u = null,
                    l = null;
                r = (u = k.SPLIT * this._hi) - this._hi, l = k.SPLIT * n, r = u - r, o = this._hi - r, s = l - n;
                var h = (u = this._hi * n) + (l = r * (s = l - s) - u + r * (a = n - s) + o * s + o * a + (this._hi * i + this._lo * n)),
                    c = l + (r = u - h);
            ...
            var t = null,
                ...
                s = null,
                a = null;
            e = (r = 1 / this._hi) - (t = (o = k.SPLIT * r) - (t = o - r)), n = (a = k.SPLIT * this._hi) - this._hi;
            var u = r + (o = (1 - (s = r * this._hi) - (a = t * (n = a - n) - s + t * (i = this._hi - n) + e * n + e * i) - r * this._lo) / this._hi);
            return new k(u, r - u + o)
        ...
        G.prototype.interfaces_ = function() {
            ...
            var r = k.valueOf(i.y).selfSubtract(n.y).selfMultiply(k.valueOf(e.x).selfSubtract(t.x)),
                o = k.valueOf(i.x).selfSubtract(n.x).selfMultiply(k.valueOf(e.y).selfSubtract(t.y)),
                s = r.subtract(o),
                a = k.valueOf(i.x).selfSubtract(n.x).selfMultiply(k.valueOf(t.y).selfSubtract(n.y)),
                u = k.valueOf(i.y).selfSubtract(n.y).selfMultiply(k.valueOf(t.x).selfSubtract(n.x)),
                l = a.subtract(u).selfDivide(s).doubleValue(),
                h = k.valueOf(t.x).selfAdd(k.valueOf(e.x).selfSubtract(t.x).selfMultiply(l)).doubleValue(),
                ...
                g = k.valueOf(n.y).selfAdd(k.valueOf(i.y).selfSubtract(n.y).selfMultiply(f)).doubleValue();
            return new N(h, g)
        ...
        var V = function() {},
            ...
            j = function() {};
        j.arraycopy = function(t, e, n, i, r) {
            for (var o = 0, s = e; s < e + r; s++) n[i + o] = t[s], o++
        }, j.getProperty = function(t) {
            return {
                "line.separator": "\n"
            }[t]
        };
        var X = function Gr() {
            if (this.x = null, this.y = null, this.w = null, 0 === arguments.length) this.x = 0, this.y = 0, this.w = 1;
                ...
                } else if (arguments[0] instanceof Gr && arguments[1] instanceof Gr) {
                    var i = arguments[0],
                        r = arguments[1];
                ...
                var h = arguments[0],
                    ...
                    m = f.x - p.x,
                    v = p.x * f.y - f.x * p.y;
                this.x = d * v - m * _, this.y = y * _ - g * v, this.w = g * m - y * d
            }
        };
        X.prototype.getY = function() {
            var t = this.y / this.w;
            if (v.isNaN(t) || v.isInfinite(t)) throw new z;
            return t
            ...
            return X
        }, X.intersection = function(t, e, n, i) {
            var r = t.y - e.y,
                o = e.x - t.x,
                s = t.x * e.y - e.x * t.y,
                a = n.y - i.y,
                ...
                c = (o * l - u * s) / h,
                p = (a * s - r * l) / h;
            if (v.isNaN(c) || v.isInfinite(c) || v.isNaN(p) || v.isInfinite(p)) throw new z;
            return new N(c, p)
        };
        var Y = function Br() {
        ...
        Y.prototype.getArea = function() {
            ...
            var t = 17;
            return t = 37 * t + N.hashCode(this._minx), t = 37 * t + N.hashCode(this._maxx), t = 37 * t + N.hashCode(this._miny), t = 37 * t + N.hashCode(this._maxy)
        }, Y.prototype.interfaces_ = function() {
            return [I, e]
        }, Y.prototype.getClass = function() {
            return Y
            ...
            if (4 === arguments.length) {
                var i = arguments[0],
                    ...
                    l = Math.min(i.x, r.x),
                    h = Math.max(i.x, r.x);
                return !(l > u || h < a || (a = Math.min(o.y, s.y), u = Math.max(o.y, s.y), l = Math.min(i.y, r.y), h = Math.max(i.y, r.y), l > u || h < a))
            }
        ...
        var W = {
            ...
            J = function(t) {
                this.geometryFactory = t || new ye
            };
        J.prototype.read = function(t) {
            var e, n, i;
            t = t.replace(/[\n\r]/g, " ");
            var r = W.typeStr.exec(t);
            if (-1 !== t.search("EMPTY") && ((r = W.emptyTypeStr.exec(t))[2] = void 0), r && (n = r[1].toLowerCase(), i = r[2], Z[n] && (e = Z[n].apply(this, [i]))), void 0 === e) throw new Error("Could not parse WKT " + t);
            return e
            ...
            if (!K[e]) return null;
            var n = e.toUpperCase();
            return t.isEmpty() ? n + " EMPTY" : n + "(" + K[e].apply(this, [t]) + ")"
        };
        var K = {
                ...
                multipoint: function(t) {
                    for (var e = [], n = 0, i = t._geometries.length; n < i; ++n) e.push("(" + K.point.apply(this, [t._geometries[n]]) + ")");
                    return e.join(",")
                },
                linestring: function(t) {
                    for (var e = [], n = 0, i = t._points._coordinates.length; n < i; ++n) e.push(K.coordinate.apply(this, [t._points._coordinates[n]]));
                    return e.join(",")
                },
                ...
                multilinestring: function(t) {
                    for (var e = [], n = 0, i = t._geometries.length; n < i; ++n) e.push("(" + K.linestring.apply(this, [t._geometries[n]]) + ")");
                    return e.join(",")
                },
                polygon: function(t) {
                    var e = [];
                    e.push("(" + K.linestring.apply(this, [t._shell]) + ")");
                    for (var n = 0, i = t._holes.length; n < i; ++n) e.push("(" + K.linestring.apply(this, [t._holes[n]]) + ")");
                    return e.join(",")
                },
                multipolygon: function(t) {
                    for (var e = [], n = 0, i = t._geometries.length; n < i; ++n) e.push("(" + K.polygon.apply(this, [t._geometries[n]]) + ")");
                    return e.join(",")
                },
            ...
            Z = {
                ...
                multipoint: function(t) {
                    ...
                    for (var e, n = t.trim().split(","), i = [], r = 0, o = n.length; r < o; ++r) e = n[r].replace(W.trimParens, "$1"), i.push(Z.point.apply(this, [e]));
                    return this.geometryFactory.createMultiPoint(i)
                },
                linestring: function(t) {
                    if (void 0 === t) return this.geometryFactory.createLineString();
                    for (var e, n = t.trim().split(","), i = [], r = 0, o = n.length; r < o; ++r) e = n[r].trim().split(W.spaces), i.push(new N(Number.parseFloat(e[0]), Number.parseFloat(e[1])));
                ...
                multilinestring: function(t) {
                    ...
                    for (var e, n = t.trim().split(W.parenComma), i = [], r = 0, o = n.length; r < o; ++r) e = n[r].replace(W.trimParens, "$1"), i.push(Z.linestring.apply(this, [e]));
                    return this.geometryFactory.createMultiLineString(i)
                },
                polygon: function(t) {
                    if (void 0 === t) return this.geometryFactory.createPolygon();
                    for (var e, n, i, r, o = t.trim().split(W.parenComma), s = [], a = 0, u = o.length; a < u; ++a) e = o[a].replace(W.trimParens, "$1"), n = Z.linestring.apply(this, [e]), i = this.geometryFactory.createLinearRing(n._points), 0 === a ? r = i : s.push(i);
                    return this.geometryFactory.createPolygon(r, s)
                },
                multipolygon: function(t) {
                    if (void 0 === t) return this.geometryFactory.createMultiPolygon();
                    for (var e, n = t.trim().split(W.doubleParenComma), i = [], r = 0, o = n.length; r < o; ++r) e = n[r].replace(W.trimParens, "$1"), i.push(Z.polygon.apply(this, [e]));
        ...
        var rt = function(t) {
                ...
                return t && (e.__proto__ = t), e.prototype = Object.create(t && t.prototype), e.prototype.constructor = e, e.prototype.isInSegmentEnvelopes = function(t) {
                    ...
                    return this.isInSegmentEnvelopes(o) || (o = new N(e.nearestEndpoint(t, n, i, r))), null !== this._precisionModel && this._precisionModel.makePrecise(o), o
                    ...
                    j.out.println("DD in env = " + s + "  --------------------- " + o), r.distance(o) > 1e-4 && j.out.println("Distance = " + r.distance(o))
                    ...
                    var o = Y.intersects(e, n, i),
                        s = Y.intersects(e, n, r),
                        a = Y.intersects(i, r, e),
                        u = Y.intersects(i, r, n);
                    ...
                    if (this._isProper = !1, !Y.intersects(e, n, i, r)) return t.NO_INTERSECTION;
                    ...
                    return a > 0 && u > 0 || a < 0 && u < 0 ? t.NO_INTERSECTION : 0 === o && 0 === s && 0 === a && 0 === u ? this.computeCollinearIntersection(e, n, i, r) : (0 === o || 0 === s || 0 === a || 0 === u ? (this._isProper = !1, e.equals2D(i) || e.equals2D(r) ? this._intPt[0] = e : n.equals2D(i) || n.equals2D(r) ? this._intPt[0] = n : 0 === o ? this._intPt[0] = new N(i) : 0 === s ? this._intPt[0] = new N(r) : 0 === a ? this._intPt[0] = new N(e) : 0 === u && (this._intPt[0] = new N(n))) : (this._isProper = !0, this._intPt[0] = this.intersection(e, n, i, r)), t.POINT_INTERSECTION)
        ...
        st.prototype.countSegment = function(t, e) {
            ...
            if (arguments[0] instanceof N && O(arguments[1], q)) {
                for (var t = arguments[0], e = arguments[1], n = new st(t), i = new N, r = new N, o = 1; o < e.size(); o++)
                    if (e.getCoordinate(o, i), e.getCoordinate(o - 1, r), n.countSegment(i, r), n.isOnSegment()) return n.getLocation();
            ...
            if (arguments[0] instanceof N && arguments[1] instanceof Array) {
                for (var s = arguments[0], a = arguments[1], u = new st(s), l = 1; l < a.length; l++) {
                    var h = a[l],
                        c = a[l - 1];
                    if (u.countSegment(h, c), u.isOnSegment()) return u.getLocation()
                }
        ...
        at.prototype.interfaces_ = function() {
            ...
            if (O(arguments[0], q)) {
                ...
                var c = l.x;
                h.x -= c;
                for (var p = 0, f = 1; f < a - 1; f++) u.y = l.y, l.x = h.x, l.y = h.y, s.getCoordinate(f + 1, h), h.x -= c, p += l.x * (u.y - h.y);
                return p / 2
            }
            ...
            return r ? T.min(at.distancePointLine(t, n, i), at.distancePointLine(e, n, i), at.distancePointLine(n, t, e), at.distancePointLine(i, t, e)) : 0
            ...
            var h = at.computeOrientation(u, n, l);
        ...
        ht.prototype.isGeometryCollection = function() {
            ...
            if (t.getSortIndex() === ht.SORTINDEX_GEOMETRYCOLLECTION) throw new m("This method does not support GeometryCollection arguments")
            ...
            return this.getSortIndex() === ht.SORTINDEX_GEOMETRYCOLLECTION || this.getSortIndex() === ht.SORTINDEX_MULTIPOINT || this.getSortIndex() === ht.SORTINDEX_MULTILINESTRING || this.getSortIndex() === ht.SORTINDEX_MULTIPOLYGON
        ...
        var Et = function() {};
        Et.prototype.add = function() {}, Et.prototype.addAll = function() {}, Et.prototype.isEmpty = function() {}, Et.prototype.iterator = function() {}, Et.prototype.size = function() {}, Et.prototype.toArray = function() {}, Et.prototype.remove = function() {}, (n.prototype = new Error).name = "IndexOutOfBoundsException";
        var It = function() {};
        It.prototype.hasNext = function() {}, It.prototype.next = function() {}, It.prototype.remove = function() {};
        var Lt = function(t) {
            function e() {
                t.apply(this, arguments)
            }
        ...
        var xt = function(t) {
                function e() {
                    t.call(this), this.array_ = [], arguments[0] instanceof Et && this.addAll(arguments[0])
                }
                ...
                return n.coordArrayType.get = function() {
                    ...
                    if (1 === arguments.length) {
                        ...
                        var g = arguments[0],
                            ...
                            m = 1;
                        _ > y && (m = -1);
                        for (var v = _; v !== y; v += m) this.add(g[v], d);
                        return !0
                    }
        ...
        St.ForwardComparator.get = function() {
            ...
            j.arraycopy(t, n, i, 0, t.length - n), j.arraycopy(t, 0, i, t.length - n, n), j.arraycopy(i, 0, t, 0, t.length)
        }, Ct.equals = function() {
            if (2 === arguments.length) {
                var t = arguments[0],
                    e = arguments[1];
            ...
            for (var n = new bt, i = 0; i < t.length; i++) e.intersects(t[i]) && n.add(t[i], !0);
            ...
            return Ct.hasRepeatedPoints(t) ? new bt(t, !1).toCoordinateArray() : t
            ...
            if (5 === arguments.length)
                for (var i = arguments[0], r = arguments[1], o = arguments[2], s = arguments[3], a = arguments[4], u = 0; u < a; u++) o[s + u] = new N(i[r + u])
        ...
        }, Mt.prototype.OLDcompare = function(t, e) {
            var n = t,
                i = e;
            if (n.length < i.length) return -1;
            if (n.length > i.length) return 1;
            if (0 === n.length) return 0;
            for (var r = Ct.increasingDirection(n), o = Ct.increasingDirection(i), s = r > 0 ? 0 : n.length - 1, a = o > 0 ? 0 : n.length - 1, u = 0; u < n.length; u++) {
        ...
        var Ot = function() {};
        Ot.prototype.get = function() {}, Ot.prototype.put = function() {}, Ot.prototype.size = function() {}, Ot.prototype.values = function() {}, Ot.prototype.entrySet = function() {};
        var Tt = function(t) {
            function e() {
                t.apply(this, arguments)
            }
        ...
        (r.prototype = new Error).name = "OperationNotSupported", (o.prototype = new Et).contains = function() {};
        var Pt = function(t) {
                function e() {
                    t.call(this), this.array_ = [], arguments[0] instanceof Et && this.addAll(arguments[0])
                }
        ...
        (c.prototype = new Tt).get = function(t) {
            ...
            for (t.color = 1; null != t && t !== this.root_ && 1 === t.parent.color;)
                if (a(t) === l(a(a(t)))) {
                    var e = h(a(a(t)));
                    1 === s(e) ? (u(a(t), Dt), u(e, Dt), u(a(a(t)), 1), t = a(a(t))) : (t === h(a(t)) && (t = a(t), this.rotateLeft(t)), u(a(t), Dt), u(a(a(t)), 1), this.rotateRight(a(a(t))))
                } else {
                    var n = l(a(a(t)));
        ...
        Ft.sort = function() {
            ...
            for (var e = new xt, n = 0, i = t.length; n < i; n++) e.add(t[n]);
            return e
        };
        var Gt = function() {},
            Bt = {
        ...
        var qt = function() {};
        qt.prototype.filter = function(t) {}, qt.prototype.interfaces_ = function() {
            return []
        ...
        var Vt = function(t) {
                ...
                return e.prototype.computeEnvelopeInternal = function() {
                    ...
                    for (var t = Gt.FALSE, e = 0; e < this._geometries.length; e++) t = Math.max(t, this._geometries[e].getBoundaryDimension());
                    return t
                }, e.prototype.getDimension = function() {
                    for (var t = Gt.FALSE, e = 0; e < this._geometries.length; e++) t = Math.max(t, this._geometries[e].getDimension());
                    return t
            ...
            zt = function(t) {
                ...
                return e.prototype.getSortIndex = function() {
                    ...
                    return new jt(this).getBoundary()
                }, e.prototype.getGeometryType = function() {
        ...
        jt.prototype.boundaryMultiLineString = function(t) {
        ...
        }, jt.prototype.getBoundary = function() {
            return this._geom instanceof Jt ? this.boundaryLineString(this._geom) : this._geom instanceof zt ? this.boundaryMultiLineString(this._geom) : this._geom.getBoundary()
        }, jt.prototype.boundaryLineString = function(t) {
        ...
        }, jt.prototype.getEmptyMultiPoint = function() {
            return this._geomFact.createMultiPoint()
        }, jt.prototype.computeBoundaryCoordinates = function(t) {
            var e = new xt;
        ...
        }, jt.prototype.addEndpoint = function(t) {
            ...
            return jt
        }, jt.getBoundary = function() {
            if (1 === arguments.length) {
                var t = arguments[0];
                return new jt(t).getBoundary()
            }
            if (2 === arguments.length) {
                var e = arguments[0],
                    n = arguments[1];
                return new jt(e, n).getBoundary()
            }
        };
        var Xt = function() {
            this.count = null
        ...
        Yt.prototype.interfaces_ = function() {
            ...
            if (2 === arguments.length) {
                for (var i = arguments[0], r = arguments[1], o = "", s = new function() {}(new function() {}(Yt.getStackTrace(i))), a = 0; a < r; a++) try {
            ...
            for (var n = e.length, i = new xt, r = "" + t, o = r.indexOf(e); o >= 0;) {
            ...
            return j.getProperty("line.separator")
        ...
        Wt.prototype.interfaces_ = function() {
            ...
            var e = t.size();
            return 0 === e || !(e <= 3) && t.getOrdinate(0, q.X) === t.getOrdinate(e - 1, q.X) && t.getOrdinate(0, q.Y) === t.getOrdinate(e - 1, q.Y)
            ...
            if (1 === arguments.length) {
                ...
                for (var r = 0; r < e; r++) {
                    r > 0 && i.append(" ");
                    for (var o = 0; o < n; o++) o > 0 && i.append(","), i.append(Yt.toString(t.getOrdinate(r, o)))
                }
                return i.append(")"), i.toString()
            }
        }, Wt.ensureValidRing = function(t, e) {
            var n = e.size();
            return 0 === n ? e : n <= 3 ? Wt.createClosedRing(t, e, 4) : e.getOrdinate(0, q.X) === e.getOrdinate(n - 1, q.X) && e.getOrdinate(0, q.Y) === e.getOrdinate(n - 1, q.Y) ? e : Wt.createClosedRing(t, e, n + 1)
        ...
        var Jt = function(t) {
                ...
                return e.prototype.computeEnvelopeInternal = function() {
                    ...
                    if (O(arguments[0], ft))
                        ...
                        n.isGeometryChanged() && this.geometryChanged()
                    } else O(arguments[0], qt) ? arguments[0].filter(this) : O(arguments[0], lt) && arguments[0].filter(this)
                }, e.prototype.getBoundary = function() {
                    return new jt(this).getBoundary()
        ...
        var $t = function(t) {
                ...
                return e.prototype.computeEnvelopeInternal = function() {
                    ...
                    if (0 === arguments.length) {
                        ...
                        j.arraycopy(e.getCoordinates(), 0, i, 0, i.length);
                        var r = Ct.minCoordinate(e.getCoordinates());
                        Ct.scroll(i, r), j.arraycopy(i, 0, e.getCoordinates(), 0, i.length), e.getCoordinates()[i.length] = i[0], at.isCCW(e.getCoordinates()) === n && Ct.reverse(e.getCoordinates())
                    }
                }, e.prototype.getCoordinate = function() {
            ...
            ee = function(t) {
                function e(e, n) {
                    e instanceof N && n instanceof ye && (e = n.getCoordinateSequenceFactory().create(e)), t.call(this, e, n), this.validateConstruction()
                }
                t && (e.__proto__ = t), (e.prototype = Object.create(t && t.prototype)).constructor = e;
                var n = {
                    MINIMUM_VALID_SIZE: {
            ...
            ne = function(t) {
                ...
                return e.prototype.getSortIndex = function() {
                    ...
                    if (this.isEmpty()) return this.getFactory().createMultiLineString();
                    for (var t = new xt, e = 0; e < this._geometries.length; e++)
        ...
        ie.prototype.setCopyUserData = function(t) {
            ...
            return null === this._factory && (this._factory = t.getFactory()), t instanceof Vt ? this.editGeometryCollection(t, e) : t instanceof $t ? this.editPolygon(t, e) : t instanceof Zt ? e.edit(t, this._factory) : t instanceof Jt ? e.edit(t, this._factory) : (et.shouldNeverReachHere("Unsupported Geometry class: " + t.getClass().getName()), null)
        }, ie.prototype.editGeometryCollection = function(t, e) {
            for (var n = e.edit(t, this._factory), i = new xt, r = 0; r < n.getNumGeometries(); r++) {
                var o = this.edit(n.getGeometryN(r), e);
                null === o || o.isEmpty() || i.add(o)
            }
            return n.getClass() === te ? this._factory.createMultiPoint(i.toArray([])) : n.getClass() === zt ? this._factory.createMultiLineString(i.toArray([])) : n.getClass() === ne ? this._factory.createMultiPolygon(i.toArray([])) : this._factory.createGeometryCollection(i.toArray([]))
            ...
            for (var r = new xt, o = 0; o < n.getNumInteriorRing(); o++) {
        ...
        se.prototype.edit = function(t, e) {
            ...
            return null === n ? t : t instanceof ee ? e.createLinearRing(n) : t instanceof Jt ? e.createLineString(n) : t instanceof Zt ? n.length > 0 ? e.createPoint(n[0]) : e.createPoint() : t
        ...
        ae.prototype.edit = function(t, e) {
            return t instanceof ee ? e.createLinearRing(this.edit(t.getCoordinateSequence(), t)) : t instanceof Jt ? e.createLineString(this.edit(t.getCoordinateSequence(), t)) : t instanceof Zt ? e.createPoint(this.edit(t.getCoordinateSequence(), t)) : t
        ...
        var pe = function(t) {
                ...
                return t && (e.__proto__ = t), e.prototype = Object.create(t && t.prototype), e.prototype.constructor = e, e.prototype.get = function(t) {
                    ...
                    for (var t = new xt, e = this.map_.values(), n = e.next(); !n.done;) t.add(n.value), n = e.next();
                    return t
            ...
            fe = function qr() {
                if (this._modelType = null, this._scale = null, 0 === arguments.length) this._modelType = qr.FLOATING;
                else if (1 === arguments.length)
                    if (arguments[0] instanceof de) {
                        var t = arguments[0];
                        this._modelType = t, t === qr.FIXED && this.setScale(1)
                    } else if ("number" == typeof arguments[0]) {
                    var e = arguments[0];
                    this._modelType = qr.FIXED, this.setScale(e)
                } else if (arguments[0] instanceof qr) {
                    var n = arguments[0];
        ...
        fe.prototype.equals = function(t) {
            ...
            return new D(n).compareTo(new D(i))
        ...
        var de = function Ur(t) {
                this._name = t || null, Ur.nameToTypeMap.put(t, this)
            },
            _e = {
                serialVersionUID: {
                    configurable: !0
        ...
        de.prototype.readResolve = function() {
            ...
            return de
        }, _e.serialVersionUID.get = function() {
            return -552860263173159e4
        }, _e.nameToTypeMap.get = function() {
            return new pe
        }, Object.defineProperties(de, _e), fe.Type = de, fe.FIXED = new de("FIXED"), fe.FLOATING = new de("FLOATING"), fe.FLOATING_SINGLE = new de("FLOATING SINGLE");
        var ye = function Vr() {
                this._precisionModel = new fe, this._SRID = 0, this._coordinateSequenceFactory = Vr.getDefaultCoordinateSequenceFactory(), 0 === arguments.length || (1 === arguments.length ? O(arguments[0], S) ? this._coordinateSequenceFactory = arguments[0] : arguments[0] instanceof fe && (this._precisionModel = arguments[0]) : 2 === arguments.length ? (this._precisionModel = arguments[0], this._SRID = arguments[1]) : 3 === arguments.length && (this._precisionModel = arguments[0], this._SRID = arguments[1], this._coordinateSequenceFactory = arguments[2]))
            },
            me = {
                serialVersionUID: {
                    configurable: !0
        ...
        ye.prototype.toGeometry = function(t) {
        ...
        }, ye.prototype.createLineString = function(t) {
            return t ? t instanceof Array ? new Jt(this.getCoordinateSequenceFactory().create(t), this) : O(t, q) ? new Jt(t, this) : void 0 : new Jt(this.getCoordinateSequenceFactory().create([]), this)
        ...
        }, ye.prototype.buildGeometry = function(t) {
            ...
            if (n || i) return this.createGeometryCollection(ye.toGeometryArray(t));
            var a = t.iterator().next();
            if (t.size() > 1) {
                if (a instanceof $t) return this.createMultiPolygon(ye.toPolygonArray(t));
                if (a instanceof Jt) return this.createMultiLineString(ye.toLineStringArray(t));
                if (a instanceof Zt) return this.createMultiPoint(ye.toPointArray(t));
                et.shouldNeverReachHere("Unhandled class: " + a.getClass().getName())
            }
            return a
        }, ye.prototype.createMultiPointFromCoords = function(t) {
        ...
        }, ye.prototype.createGeometry = function(t) {
            ...
            return ye
        }, ye.toMultiPolygonArray = function(t) {
            var e = new Array(t.size()).fill(null);
            return t.toArray(e)
        }, ye.toGeometryArray = function(t) {
            if (null === t) return null;
            var e = new Array(t.size()).fill(null);
            return t.toArray(e)
        }, ye.getDefaultCoordinateSequenceFactory = function() {
            return he.instance()
        }, ye.toMultiLineStringArray = function(t) {
            var e = new Array(t.size()).fill(null);
            return t.toArray(e)
        }, ye.toLineStringArray = function(t) {
            var e = new Array(t.size()).fill(null);
            return t.toArray(e)
        }, ye.toMultiPointArray = function(t) {
            var e = new Array(t.size()).fill(null);
            return t.toArray(e)
        }, ye.toLinearRingArray = function(t) {
            var e = new Array(t.size()).fill(null);
            return t.toArray(e)
        }, ye.toPointArray = function(t) {
            var e = new Array(t.size()).fill(null);
            return t.toArray(e)
        }, ye.toPolygonArray = function(t) {
            var e = new Array(t.size()).fill(null);
            return t.toArray(e)
        }, ye.createPointFromInternalCoord = function(t, e) {
            return e.getPrecisionModel().makePrecise(t), e.getFactory().createPoint(t)
        }, me.serialVersionUID.get = function() {
            return -0x5ea75f2051eeb400
        }, Object.defineProperties(ye, me);
        ...
        Ee.prototype.read = function(t) {
            ...
            if (!Ie[n]) throw new Error("Unknown GeoJSON type: " + e.type);
            return -1 !== ve.indexOf(n) ? Ie[n].apply(this, [e.coordinates]) : "GeometryCollection" === n ? Ie[n].apply(this, [e.geometries]) : Ie[n].apply(this, [e])
        }, Ee.prototype.write = function(t) {
            var e = t.getGeometryType();
            if (!Le[e]) throw new Error("Geometry is not supported");
            return Le[e].apply(this, [t])
        };
        var Ie = {
                Feature: function(t) {
                    var e = {};
                    ...
                    if (t.geometry) {
                        ...
                        if (!Ie[i]) throw new Error("Unknown GeoJSON type: " + t.type);
                        e.geometry = this.read(t.geometry)
                    }
                    return t.bbox && (e.bbox = Ie.bbox.apply(this, [t.bbox])), e
                },
                ...
                MultiPoint: function(t) {
                    for (var e = [], n = 0; n < t.length; ++n) e.push(Ie.Point.apply(this, [t[n]]));
                    return this.geometryFactory.createMultiPoint(e)
                },
                LineString: function(t) {
                    var e = Ie.coordinates.apply(this, [t]);
                    return this.geometryFactory.createLineString(e)
                },
                MultiLineString: function(t) {
                    for (var e = [], n = 0; n < t.length; ++n) e.push(Ie.LineString.apply(this, [t[n]]));
                    return this.geometryFactory.createMultiLineString(e)
                },
                Polygon: function(t) {
                    for (var e = Ie.coordinates.apply(this, [t[0]]), n = this.geometryFactory.createLinearRing(e), i = [], r = 1; r < t.length; ++r) {
                        var o = t[r],
                            s = Ie.coordinates.apply(this, [o]),
                ...
                MultiPolygon: function(t) {
                    for (var e = [], n = 0; n < t.length; ++n) {
                        var i = t[n];
                        e.push(Ie.Polygon.apply(this, [i]))
                    }
            ...
            Le = {
                ...
                Point: function(t) {
                    return {
                        type: "Point",
                        coordinates: Le.coordinate.apply(this, [t.getCoordinate()])
                    }
                },
                MultiPoint: function(t) {
                    for (var e = [], n = 0; n < t._geometries.length; ++n) {
                        var i = t._geometries[n],
                            r = Le.Point.apply(this, [i]);
                ...
                LineString: function(t) {
                    for (var e = [], n = t.getCoordinates(), i = 0; i < n.length; ++i) {
                        var r = n[i];
                        e.push(Le.coordinate.apply(this, [r]))
                    }
                    return {
                        type: "LineString",
                        coordinates: e
                ...
                Polygon: function(t) {
                    var e = [],
                        n = Le.LineString.apply(this, [t._shell]);
                    e.push(n.coordinates);
                    for (var i = 0; i < t._holes.length; ++i) {
                        var r = t._holes[i],
                            o = Le.LineString.apply(this, [r]);
            ...
            xe = function(t) {
                this.geometryFactory = t || new ye, this.precisionModel = this.geometryFactory.getPrecisionModel(), this.parser = new Ee(this.geometryFactory)
            };
        xe.prototype.read = function(t) {
            var e = this.parser.read(t);
            return this.precisionModel.getType() === fe.FIXED && this.reducePrecision(e), e
        }, xe.prototype.reducePrecision = function(t) {
            var e, n;
        ...
        var Ne = function() {
            this.parser = new Ee(this.geometryFactory)
        };
        ...
        be.prototype.interfaces_ = function() {
            ...
            return be
        }, be.opposite = function(t) {
            return t === be.LEFT ? be.RIGHT : t === be.RIGHT ? be.LEFT : t
        }, Ce.ON.get = function() {
            return 0
            ...
            return 2
        }, Object.defineProperties(be, Ce), (d.prototype = new Error).name = "EmptyStackException", (_.prototype = new Lt).add = function(t) {
            return this.array_.push(t), !0
        ...
        Se.prototype.getCoordinate = function() {
            ...
            var i = be.LEFT;
            return n[e].y < n[e + 1].y && (i = be.RIGHT), i
        ...
        Me.prototype.addLast = function(t) {
            this.array_.push(t)
        }, Me.prototype.removeFirst = function() {
            return this.array_.shift()
        }, Me.prototype.isEmpty = function() {
            return 0 === this.array_.length
        };
        var Oe = function() {
            this._finder = null, this._dirEdgeList = new xt, this._nodes = new xt, this._rightMostCoord = null, this._env = null, this._finder = new Se
        };
        Oe.prototype.clearVisitedEdges = function() {
            ...
            e.setEdgeDepths(be.RIGHT, t), this.copySymDepths(e), this.computeDepths(e)
        }, Oe.prototype.create = function(t) {
            this.addReachable(t), this._finder.findEdge(this._dirEdgeList), this._rightMostCoord = this._finder.getCoordinate()
        }, Oe.prototype.findResultEdges = function() {
            for (var t = this._dirEdgeList.iterator(); t.hasNext();) {
                var e = t.next();
                e.getDepth(be.RIGHT) >= 1 && e.getDepth(be.LEFT) <= 0 && !e.isInteriorAreaEdge() && e.setInResult(!0)
            }
            ...
            var e = t.getSym();
            e.setDepth(be.LEFT, t.getDepth(be.RIGHT)), e.setDepth(be.RIGHT, t.getDepth(be.LEFT))
        ...
        var Te = function zr() {
            if (this.location = null, 1 === arguments.length) {
                if (arguments[0] instanceof Array) {
                    ...
                    var e = arguments[0];
                    this.init(1), this.location[be.ON] = e
                ...
                var r = arguments[0],
                    o = arguments[1],
                    s = arguments[2];
                this.init(3), this.location[be.ON] = r, this.location[be.LEFT] = o, this.location[be.RIGHT] = s
            }
        };
        Te.prototype.setAllLocations = function(t) {
            ...
            if (t.location.length > this.location.length) {
                ...
                e[be.ON] = this.location[be.ON], e[be.LEFT] = w.NONE, e[be.RIGHT] = w.NONE, this.location = e
            }
            ...
            var t = this.location[be.LEFT];
            this.location[be.LEFT] = this.location[be.RIGHT], this.location[be.RIGHT] = t
        }, Te.prototype.toString = function() {
            var t = new R;
            return this.location.length > 1 && t.append(w.toLocationSymbol(this.location[be.LEFT])), t.append(w.toLocationSymbol(this.location[be.ON])), this.location.length > 1 && t.append(w.toLocationSymbol(this.location[be.RIGHT])), t.toString()
        }, Te.prototype.setLocations = function(t, e, n) {
            this.location[be.ON] = t, this.location[be.LEFT] = e, this.location[be.RIGHT] = n
        ...
        var Pe = function jr() {
            if (this.elt = new Array(2).fill(null), 1 === arguments.length) {
                if (Number.isInteger(arguments[0])) {
                    ...
                    var e = arguments[0];
                    this.elt[0] = new Te(e.elt[0]), this.elt[1] = new Te(e.elt[1])
                }
            } else if (2 === arguments.length) {
                var n = arguments[0],
                    i = arguments[1];
                this.elt[0] = new Te(w.NONE), this.elt[1] = new Te(w.NONE), this.elt[n].setLocation(i)
            } else if (3 === arguments.length) {
                var r = arguments[0],
                    o = arguments[1],
                    s = arguments[2];
                this.elt[0] = new Te(r, o, s), this.elt[1] = new Te(r, o, s)
            } else if (4 === arguments.length) {
                var a = arguments[0],
                    u = arguments[1],
                    l = arguments[2],
                    h = arguments[3];
                this.elt[0] = new Te(w.NONE, w.NONE, w.NONE), this.elt[1] = new Te(w.NONE, w.NONE, w.NONE), this.elt[a].setLocations(u, l, h)
            }
        };
        Pe.prototype.getGeometryCount = function() {
            ...
            if (2 === arguments.length) {
                var t = arguments[0],
                    e = arguments[1];
                this.elt[t].setLocation(be.ON, e)
            } else if (3 === arguments.length) {
                var n = arguments[0],
                    i = arguments[1],
                    r = arguments[2];
        ...
        var Re = function() {
            this._startDe = null, this._maxNodeDegree = -1, this._edges = new xt, this._pts = new xt, this._label = new Pe(w.NONE), this._ring = null, this._isHole = null, this._shell = null, this._holes = new xt, this._geometryFactory = null;
            var t = arguments[0],
                e = arguments[1];
        ...
        Ge.prototype.find = function(t) {
            ...
            for (var e = new xt, n = this.iterator(); n.hasNext();) {
                var i = n.next();
        ...
        var Ve = function(t) {
                ...
                return t && (e.__proto__ = t), e.prototype = Object.create(t && t.prototype), e.prototype.constructor = e, e.prototype.getNextMin = function() {
                    ...
                    for (var t = !0, e = 0; e < 2; e++) this._label.isArea(e) && this._label.getLocation(e, be.LEFT) === w.INTERIOR && this._label.getLocation(e, be.RIGHT) === w.INTERIOR || (t = !1);
                    return t
                }, e.prototype.setNextMin = function(t) {
                    this._nextMin = t
                }, e.prototype.print = function(e) {
                    t.prototype.print.call(this, e), e.print(" " + this._depth[be.LEFT] + "/" + this._depth[be.RIGHT]), e.print(" (" + this.getDepthDelta() + ")"), this._isInResult && e.print(" inResult")
        ...
        var je = function() {
            if (this._edges = new xt, this._nodes = null, this._edgeEndList = new xt, 0 === arguments.length) this._nodes = new Ge(new ze);
            else if (1 === arguments.length) {
                var t = arguments[0];
        ...
        var Xe = function() {
            this._geometryFactory = null, this._shellList = new xt;
            var t = arguments[0];
        ...
        Xe.prototype.sortShellsAndHoles = function(t, e, n) {
            ...
            for (var e = new xt, n = t.iterator(); n.hasNext();) {
            ...
            for (var i = new xt, r = t.iterator(); r.hasNext();) {
                var o = r.next();
            ...
            for (var n = t.getLinearRing(), i = n.getEnvelopeInternal(), r = n.getCoordinateN(0), o = null, s = null, a = e.iterator(); a.hasNext();) {
                ...
                var c = !1;
                h.contains(i) && at.isPointInRing(r, l.getCoordinates()) && (c = !0), c && (null === o || s.contains(h)) && (o = u)
            }
            return o
        ...
        var We = function() {
            this._size = null, this._items = null, this._size = 0, this._items = new xt, this._items.add(null)
        };
        ...
        var Je = function() {};
        Je.prototype.visitItem = function(t) {}, Je.prototype.interfaces_ = function() {
            return []
        }, Je.prototype.getClass = function() {
            return Je
        };
        var Ke = function() {};
        Ke.prototype.insert = function(t, e) {}, Ke.prototype.remove = function(t, e) {}, Ke.prototype.query = function() {}, Ke.prototype.interfaces_ = function() {
            return []
        }, Ke.prototype.getClass = function() {
            return Ke
        };
        var Ze = function() {
                if (this._childBoundables = new xt, this._bounds = null, this._level = null, 0 === arguments.length);
                else if (1 === arguments.length) {
                    var t = arguments[0];
                    this._level = t
                }
        ...
        Ze.prototype.getLevel = function() {
            return this._level
        }, Ze.prototype.size = function() {
            return this._childBoundables.size()
        }, Ze.prototype.getChildBoundables = function() {
            return this._childBoundables
        }, Ze.prototype.addChildBoundable = function(t) {
            et.isTrue(null === this._bounds), this._childBoundables.add(t)
        }, Ze.prototype.isEmpty = function() {
            return this._childBoundables.isEmpty()
        }, Ze.prototype.getBounds = function() {
        ...
        var en = function Xr() {
                if (this._root = null, this._built = !1, this._itemBoundables = new xt, this._nodeCapacity = null, 0 === arguments.length) {
                    var t = Xr.DEFAULT_NODE_CAPACITY;
                    this._nodeCapacity = t
                } else if (1 === arguments.length) {
                    var e = arguments[0];
                    et.isTrue(e > 1, "Node capacity must be greater than 1"), this._nodeCapacity = e
                }
            },
            nn = {
                IntersectsOp: {
        ...
        en.prototype.getNodeCapacity = function() {
            ...
            if (1 === arguments.length) {
                for (var t = 0, e = arguments[0].getChildBoundables().iterator(); e.hasNext();) {
                    var n = e.next();
                    n instanceof Ze ? t += this.size(n) : n instanceof He && (t += 1)
                }
                return t
            }
            ...
            if (0 === arguments.length) {
                ...
                return null === t ? new xt : t
            }
            if (1 === arguments.length) {
                for (var e = arguments[0], n = new xt, i = e.getChildBoundables().iterator(); i.hasNext();) {
                    var r = i.next();
                    if (r instanceof Ze) {
            ...
            if (3 === arguments.length) {
                ...
                for (var o = i.getChildBoundables().iterator(); o.hasNext();) {
                    var s = o.next();
                    s instanceof Ze ? this.boundablesAtLevel(n, s, r) : (et.isTrue(s instanceof He), -1 === n && r.add(s))
                }
                return null
            }
            ...
            if (2 === arguments.length) {
                ...
                if (O(arguments[2], Je) && arguments[0] instanceof Object && arguments[1] instanceof Ze)
                    for (var r = arguments[0], o = arguments[1], s = arguments[2], a = o.getChildBoundables(), u = 0; u < a.size(); u++) {
                        var l = a.get(u);
                        this.getIntersectsOp().intersects(l.getBounds(), r) && (l instanceof Ze ? this.query(r, l, s) : l instanceof He ? s.visitItem(l.getItem()) : et.shouldNeverReachHere())
                    } else if (O(arguments[2], Lt) && arguments[0] instanceof Object && arguments[1] instanceof Ze)
                        for (var h = arguments[0], c = arguments[1], p = arguments[2], f = c.getChildBoundables(), g = 0; g < f.size(); g++) {
                            var d = f.get(g);
                            this.getIntersectsOp().intersects(d.getBounds(), h) && (d instanceof Ze ? this.query(h, d, p) : d instanceof He ? p.add(d.getItem()) : et.shouldNeverReachHere())
                        }
            ...
            if (3 === arguments.length) {
                ...
                for (var s = null, a = i.getChildBoundables().iterator(); a.hasNext();) {
                    var u = a.next();
                    if (this.getIntersectsOp().intersects(u.getBounds(), n) && u instanceof Ze && (o = this.remove(n, u, r))) {
                        s = u;
                        break
                    }
                }
        ...
        var sn = function(t) {
                ...
                return n.prototype.createParentBoundablesFromVerticalSlices = function(t, e) {
                    ...
                    for (var n = new xt, i = 0; i < t.length; i++) n.addAll(this.createParentBoundablesFromVerticalSlice(t[i], e));
                    return n
                    ...
                    if (1 === arguments.length) {
                        ...
                        if (arguments[0] instanceof n && O(arguments[1], on)) {
                            var r = arguments[0],
                                o = arguments[1],
        ...
        var ln = function() {
            ...
            var t = arguments[0],
                ...
                n = arguments[2],
                i = arguments[3];
            this._segString = t, this.coord = new N(e), this.segmentIndex = n, this._segmentOctant = i, this._isInterior = !e.equals2D(t.getCoordinate(n))
        };
        ...
        hn.prototype.getSplitCoordinates = function() {
            ...
            for (var e = new Array(1).fill(null), n = this.iterator(), i = n.next(); n.hasNext();) {
                var r = n.next();
                this.findCollapseIndex(i, r, e) && t.add(new D(e[0])), i = r
            }
            ...
            return r && (o[s] = new N(e.coord)), new gn(o, this._edge.getData())
        ...
        var gn = function() {
            this._nodeList = new hn(this), this._pts = null, this._data = null;
            var t = arguments[0],
                e = arguments[1];
        ...
        gn.prototype.getCoordinates = function() {
            ...
            if (2 === arguments.length)
                for (var n = arguments[0], i = arguments[1], r = n.iterator(); r.hasNext();) r.next().getNodeList().addSplitEdges(i)
        };
        var dn = function() {
                if (this.p0 = null, this.p1 = null, 0 === arguments.length) this.p0 = new N, this.p1 = new N;
                    ...
                    var e = arguments[0],
                        ...
                        i = arguments[2],
                        r = arguments[3];
                    this.p0 = new N(e, n), this.p1 = new N(i, r)
                }
            },
            _n = {
                serialVersionUID: {
        ...
        mn.prototype.getLineSegment = function(t, e) {
            ...
            var h = Math.trunc((t + e) / 2),
                c = Math.trunc((i + r) / 2);
            t < h && (i < c && this.computeOverlapsInternal(t, h, n, i, c, o), c < r && this.computeOverlapsInternal(t, h, n, c, r, o)), h < e && (i < c && this.computeOverlapsInternal(h, e, n, i, c, o), c < r && this.computeOverlapsInternal(h, e, n, c, r, o))
        ...
        vn.prototype.interfaces_ = function() {
            ...
            if (2 === arguments.length) {
                for (var e = arguments[0], n = arguments[1], i = new xt, r = vn.getChainStartIndices(e), o = 0; o < r.length - 1; o++) {
        ...
        var En = function() {};
        En.prototype.computeNodes = function(t) {}, En.prototype.getNodedSubstrings = function() {}, En.prototype.interfaces_ = function() {
            return []
        }, En.prototype.getClass = function() {
            return En
        };
        ...
        In.prototype.setSegmentIntersector = function(t) {
            this._segInt = t
        ...
        var Ln = function(t) {
                function e(e) {
                    e ? t.call(this, e) : t.call(this), this._monoChains = new xt, this._index = new sn, this._idCounter = 0, this._nodedSegStrings = null, this._nOverlaps = 0
                }
                t && (e.__proto__ = t), (e.prototype = Object.create(t && t.prototype)).constructor = e;
                var n = {
                ...
                return e.prototype.getMonotoneChains = function() {
                    ...
                    for (var t = new xn(this._segInt), e = this._monoChains.iterator(); e.hasNext();)
            ...
            Nn = function Yr() {
                if (this._quadrantSegments = Yr.DEFAULT_QUADRANT_SEGMENTS, this._endCapStyle = Yr.CAP_ROUND, this._joinStyle = Yr.JOIN_ROUND, this._mitreLimit = Yr.DEFAULT_MITRE_LIMIT, this._isSingleSided = !1, this._simplifyFactor = Yr.DEFAULT_SIMPLIFY_FACTOR, 0 === arguments.length);
                else if (1 === arguments.length) {
                    var t = arguments[0];
                    ...
                    var i = arguments[0],
                        ...
                        o = arguments[2],
                        s = arguments[3];
                    this.setQuadrantSegments(i), this.setEndCapStyle(r), this.setJoinStyle(o), this.setMitreLimit(s)
                }
            },
            bn = {
                CAP_ROUND: {
        ...
        }, bn.CAP_ROUND.get = function() {
            return 1
        }, bn.CAP_FLAT.get = function() {
            return 2
        }, bn.CAP_SQUARE.get = function() {
            return 3
        }, bn.JOIN_ROUND.get = function() {
            return 1
        }, bn.JOIN_MITRE.get = function() {
            return 2
        }, bn.JOIN_BEVEL.get = function() {
            return 3
        }, bn.DEFAULT_QUADRANT_SEGMENTS.get = function() {
            return 8
        }, bn.DEFAULT_MITRE_LIMIT.get = function() {
            return 5
        }, bn.DEFAULT_SIMPLIFY_FACTOR.get = function() {
            return .01
        }, Object.defineProperties(Nn, bn);
        var Cn = function(t) {
        ...
        Cn.prototype.isDeletable = function(t, e, n, i) {
            ...
            for (var t = 1, e = this.findNextNonDeletedIndex(t), n = this.findNextNonDeletedIndex(e), i = !1; n < this._inputLine.length;) {
                var r = !1;
                this.isDeletable(t, e, n, this._distanceTol) && (this._isDeleted[e] = Cn.DELETE, r = !0, i = !0), t = r ? n : e, e = this.findNextNonDeletedIndex(t), n = this.findNextNonDeletedIndex(e)
            }
            return i
            ...
            for (var t = new bt, e = 0; e < this._inputLine.length; e++) this._isDeleted[e] !== Cn.DELETE && t.add(this._inputLine[e]);
            return t.toCoordinateArray()
        }, Cn.prototype.interfaces_ = function() {
            return []
        }, Cn.prototype.getClass = function() {
        ...
        var wn = function() {
                this._ptList = null, this._precisionModel = null, this._minimimVertexDistance = 0, this._ptList = new xt
            },
            Mn = {
        ...
        wn.prototype.getCoordinates = function() {
            ...
            return wn
        }, Mn.COORDINATE_ARRAY_TYPE.get = function() {
            return new Array(0).fill(null)
        ...
        }, On.isAcute = function(t, e, n) {
            var i = t.x - e.x,
                r = t.y - e.y;
            return i * (n.x - e.x) + r * (n.y - e.y) > 0
        }, On.isObtuse = function(t, e, n) {
            var i = t.x - e.x,
                r = t.y - e.y;
            return i * (n.x - e.x) + r * (n.y - e.y) < 0
        }, On.interiorAngle = function(t, e, n) {
            var i = On.angle(e, t),
                r = On.angle(e, n);
            return Math.abs(r - i)
        }, On.normalizePositive = function(t) {
            if (t < 0) {
                for (; t < 0;) t += On.PI_TIMES_2;
                t >= On.PI_TIMES_2 && (t = 0)
            } else {
                for (; t >= On.PI_TIMES_2;) t -= On.PI_TIMES_2;
                t < 0 && (t = 0)
            }
            return t
        }, On.angleBetween = function(t, e, n) {
            var i = On.angle(e, t),
                r = On.angle(e, n);
            return On.diff(i, r)
        }, On.diff = function(t, e) {
            var n = null;
            return (n = t < e ? e - t : t - e) > Math.PI && (n = 2 * Math.PI - n), n
        }, On.toRadians = function(t) {
            return t * Math.PI / 180
        }, On.getTurn = function(t, e) {
            var n = Math.sin(e - t);
            return n > 0 ? On.COUNTERCLOCKWISE : n < 0 ? On.CLOCKWISE : On.NONE
        }, On.angleBetweenOriented = function(t, e, n) {
            var i = On.angle(e, t),
                r = On.angle(e, n) - i;
            return r <= -Math.PI ? r + On.PI_TIMES_2 : r > Math.PI ? r - On.PI_TIMES_2 : r
        ...
        var Pn = function Hr() {
                ...
                var t = arguments[0],
                    e = arguments[1],
                    n = arguments[2];
                this._precisionModel = t, this._bufParams = e, this._li = new rt, this._filletAngleQuantum = Math.PI / 2 / e.getQuadrantSegments(), e.getQuadrantSegments() >= 8 && e.getJoinStyle() === Nn.JOIN_ROUND && (this._closingSegLengthFactor = Hr.MAX_CLOSING_SEG_LEN_FACTOR), this.init(n)
            },
            Rn = {
        ...
        Pn.prototype.addNextSegment = function(t, e) {
            ...
            var n = at.computeOrientation(this._s0, this._s1, this._s2),
                i = n === at.CLOCKWISE && this._side === be.LEFT || n === at.COUNTERCLOCKWISE && this._side === be.RIGHT;
            0 === n ? this.addCollinear(e) : i ? this.addOutsideTurn(n, e) : this.addInsideTurn(n, e)
        }, Pn.prototype.addLineEndCap = function(t, e) {
            var n = new dn(t, e),
                i = new dn;
            this.computeOffsetSegment(n, be.LEFT, this._distance, i);
            var r = new dn;
            this.computeOffsetSegment(n, be.RIGHT, this._distance, r);
            var o = e.x - t.x,
                s = e.y - t.y,
                a = Math.atan2(s, o);
            switch (this._bufParams.getEndCapStyle()) {
                ...
                case Nn.CAP_SQUARE:
                    ...
                    var l = new N(i.p1.x + u.x, i.p1.y + u.y),
                        h = new N(r.p1.x + u.x, r.p1.y + u.y);
            ...
            var r = !0,
                o = null;
            try {
                o = X.intersection(e.p0, e.p1, n.p0, n.p1), (i <= 0 ? 1 : o.distance(t) / Math.abs(i)) > this._bufParams.getMitreLimit() && (r = !1)
            } catch (t) {
                if (!(t instanceof z)) throw t;
                o = new N(0, 0), r = !1
            }
            ...
            var o = e.x - t.x,
                ...
                l = n.y - t.y,
                h = Math.atan2(l, u);
            i === at.CLOCKWISE ? a <= h && (a += 2 * Math.PI) : a >= h && (a -= 2 * Math.PI), this._segList.addPt(e), this.addFilletArc(t, a, h, i, r), this._segList.addPt(n)
            ...
            var r = this._seg0.p1,
                o = On.angle(r, this._seg0.p0),
                s = On.angleBetweenOriented(this._seg0.p0, r, this._seg1.p1) / 2,
                a = On.normalize(o + s),
                ...
                _ = g.pointAlongOffset(1, -h);
            this._side === be.LEFT ? (this._segList.addPt(d), this._segList.addPt(_)) : (this._segList.addPt(_), this._segList.addPt(d))
            ...
            if (this._li.computeIntersection(this._offset0.p0, this._offset0.p1, this._offset1.p0, this._offset1.p1), this._li.hasIntersection()) this._segList.addPt(this._li.getIntersection(0));
                ...
                if (this._segList.addPt(this._offset0.p1), this._closingSegLengthFactor > 0) {
                    ...
                    var i = new N((this._closingSegLengthFactor * this._offset1.p0.x + this._s1.x) / (this._closingSegLengthFactor + 1), (this._closingSegLengthFactor * this._offset1.p0.y + this._s1.y) / (this._closingSegLengthFactor + 1));
        ...
        Dn.prototype.getOffsetCurve = function(t, e) {
            ...
            if (e) {
                ...
                var r = Cn.simplify(t, -i),
                    o = r.length - 1;
                n.initSideSegments(r[o], r[o - 1], be.LEFT), n.addFirstSegment();
                for (var s = o - 2; s >= 0; s--) n.addNextSegment(r[s], !0)
            } else {
                n.addSegments(t, !1);
                var a = Cn.simplify(t, i),
                    u = a.length - 1;
                n.initSideSegments(a[0], a[1], be.LEFT), n.addFirstSegment();
        ...
        An.prototype.findStabbedSegments = function() {
            if (1 === arguments.length) {
                for (var t = arguments[0], e = new xt, n = this._subgraphs.iterator(); n.hasNext();) {
                    var i = n.next(),
                        r = i.getEnvelope();
            ...
            if (3 === arguments.length)
                if (O(arguments[2], Lt) && arguments[0] instanceof N && arguments[1] instanceof Ve) {
                    for (var o = arguments[0], s = arguments[1], a = arguments[2], u = s.getEdge().getCoordinates(), l = 0; l < u.length - 1; l++)
                        if (this._seg.p0 = u[l], this._seg.p1 = u[l + 1], this._seg.p0.y > this._seg.p1.y && this._seg.reverse(), !(Math.max(this._seg.p0.x, this._seg.p1.x) < o.x || this._seg.isHorizontal() || o.y < this._seg.p0.y || o.y > this._seg.p1.y || at.computeOrientation(this._seg.p0, this._seg.p1, o) === at.RIGHT)) {
                            var h = s.getDepth(be.LEFT);
                            this._seg.p0.equals(u[l]) || (h = s.getDepth(be.RIGHT));
                            var c = new Fn(this._seg, h);
                            a.add(c)
                        }
                } else if (O(arguments[2], Lt) && arguments[0] instanceof N && O(arguments[1], Lt))
                for (var p = arguments[0], f = arguments[1], g = arguments[2], d = f.iterator(); d.hasNext();) {
                    var _ = d.next();
                    _.isForward() && this.findStabbedSegments(p, _, g)
                }
        ...
        Gn.prototype.area = function() {
            ...
            var i = n.x,
                ...
                c = Gn.det(o, o * o + s * s, a, a * a + u * u);
            return new N(i - h / l, r + c / l)
        }, Gn.perpendicularBisector = function(t, e) {
            var n = e.x - t.x,
                i = e.y - t.y,
                r = new X(t.x + n / 2, t.y + i / 2, 1),
                o = new X(t.x - i + n / 2, t.y + n + i / 2, 1);
            return new X(r, o)
        ...
        var Bn = function() {
            this._inputGeom = null, this._distance = null, this._curveBuilder = null, this._curveList = new xt;
            var t = arguments[0],
                e = arguments[1],
                n = arguments[2];
        ...
        Bn.prototype.addPoint = function(t) {
            ...
            var e = this._distance,
                n = be.LEFT;
            this._distance < 0 && (e = -this._distance, n = be.RIGHT);
            ...
            for (var o = 0; o < t.getNumInteriorRing(); o++) {
                ...
                this._distance > 0 && this.isErodedCompletely(s, -this._distance) || this.addPolygonRing(a, e, be.opposite(n), w.INTERIOR, w.EXTERIOR)
            }
            ...
            var o = i,
                s = r;
            t.length >= ee.MINIMUM_VALID_SIZE && at.isCCW(t) && (o = r, s = i, n = be.opposite(n));
            var a = this._curveBuilder.getRingCurve(t, n, e);
            this.addCurve(a, o, s)
        }, Bn.prototype.add = function(t) {
            if (t.isEmpty()) return null;
            t instanceof $t ? this.addPolygon(t) : t instanceof Jt ? this.addLineString(t) : t instanceof Zt ? this.addPoint(t) : t instanceof te ? this.addCollection(t) : t instanceof zt ? this.addCollection(t) : t instanceof ne ? this.addCollection(t) : t instanceof Vt && this.addCollection(t)
        ...
        var qn = function() {};
        qn.prototype.locate = function(t) {}, qn.prototype.interfaces_ = function() {
            return []
        ...
        Un.prototype.next = function() {
            ...
            return t instanceof Vt ? (this._subcollectionIterator = new Un(t), this._subcollectionIterator.next()) : t
        ...
        Vn.prototype.locate = function(t) {
            return Vn.locate(t, this._geom)
        }, Vn.prototype.interfaces_ = function() {
            return [qn]
        }, Vn.prototype.getClass = function() {
            return Vn
        }, Vn.isPointInRing = function(t, e) {
            return !!e.getEnvelopeInternal().intersects(t) && at.isPointInRing(t, e.getCoordinates())
        }, Vn.containsPointInPolygon = function(t, e) {
            if (e.isEmpty()) return !1;
            var n = e.getExteriorRing();
            if (!Vn.isPointInRing(t, n)) return !1;
            for (var i = 0; i < e.getNumInteriorRing(); i++) {
                var r = e.getInteriorRingN(i);
                if (Vn.isPointInRing(t, r)) return !1
            }
            return !0
        }, Vn.containsPoint = function(t, e) {
            if (e instanceof $t) return Vn.containsPointInPolygon(t, e);
            if (e instanceof Vt)
                for (var n = new Un(e); n.hasNext();) {
                    var i = n.next();
                    if (i !== e && Vn.containsPoint(t, i)) return !0
                }
            return !1
        }, Vn.locate = function(t, e) {
            return e.isEmpty() ? w.EXTERIOR : Vn.containsPoint(t, e) ? w.INTERIOR : w.EXTERIOR
        };
        var zn = function() {
            this._edgeMap = new c, this._edgeList = null, this._ptInAreaLocation = [w.NONE, w.NONE]
        };
        zn.prototype.getNextCW = function(t) {
            this.getEdges();
            var e = this._edgeList.indexOf(t),
                n = e - 1;
            return 0 === e && (n = this._edgeList.size() - 1), this._edgeList.get(n)
        }, zn.prototype.propagateSideLabels = function(t) {
            for (var e = w.NONE, n = this.iterator(); n.hasNext();) {
                var i = n.next().getLabel();
                i.isArea(t) && i.getLocation(t, be.LEFT) !== w.NONE && (e = i.getLocation(t, be.LEFT))
            }
            if (e === w.NONE) return null;
            for (var r = e, o = this.iterator(); o.hasNext();) {
                var s = o.next(),
                    a = s.getLabel();
                if (a.getLocation(t, be.ON) === w.NONE && a.setLocation(t, be.ON, r), a.isArea(t)) {
                    var u = a.getLocation(t, be.LEFT),
                        l = a.getLocation(t, be.RIGHT);
                    if (l !== w.NONE) {
                    ...
                    } else et.isTrue(a.getLocation(t, be.LEFT) === w.NONE, "found single null side"), a.setLocation(t, be.RIGHT, r), a.setLocation(t, be.LEFT, r)
                }
            }
            ...
            j.out.println("EdgeEndStar:   " + this.getCoordinate());
            for (var e = this.iterator(); e.hasNext();) e.next().print(t)
        }, zn.prototype.isAreaLabelsConsistent = function(t) {
            return this.computeEdgeEndLabels(t.getBoundaryNodeRule()), this.checkAreaLabelsConsistent(0)
        }, zn.prototype.checkAreaLabelsConsistent = function(t) {
            var e = this.getEdges();
            if (e.size() <= 0) return !0;
            var n = e.size() - 1,
                i = e.get(n).getLabel().getLocation(t, be.LEFT);
            ...
            for (var r = i, o = this.iterator(); o.hasNext();) {
                ...
                var a = s.getLocation(t, be.LEFT),
                    u = s.getLocation(t, be.RIGHT);
                if (a === u) return !1;
                if (u !== r) return !1;
                r = a
            }
            return !0
        }, zn.prototype.findIndex = function(t) {
            this.iterator();
        ...
        }, zn.prototype.getEdges = function() {
            return null === this._edgeList && (this._edgeList = new xt(this._edgeMap.values())), this._edgeList
        }, zn.prototype.getLocation = function(t, e, n) {
            return this._ptInAreaLocation[t] === w.NONE && (this._ptInAreaLocation[t] = Vn.locate(e, n[t].getGeometry())), this._ptInAreaLocation[t]
            ...
            return t.toString()
        }, zn.prototype.computeEdgeEndLabels = function(t) {
            for (var e = this.iterator(); e.hasNext();) e.next().computeLabel(t)
        }, zn.prototype.computeLabelling = function(t) {
        ...
        }, zn.prototype.getDegree = function() {
            return this._edgeMap.size()
        }, zn.prototype.insertEdgeEnd = function(t, e) {
        ...
        var jn = function(t) {
                ...
                return t && (e.__proto__ = t), e.prototype = Object.create(t && t.prototype), e.prototype.constructor = e, e.prototype.linkResultDirectedEdges = function() {
                    ...
                    j.out.println("DirectedEdgeStar: " + this.getCoordinate());
                    for (var e = this.iterator(); e.hasNext();) {
                        var n = e.next();
                    ...
                    this._resultAreaEdgeList = new xt;
                    ...
                    if (1 === arguments.length) {
                        var t = arguments[0],
                            e = this.findIndex(t),
                            n = t.getDepth(be.LEFT),
                            i = t.getDepth(be.RIGHT),
                        ...
                        for (var o = arguments[0], s = arguments[1], a = arguments[2], u = o; u < s; u++) {
                            ...
                            l.setEdgeDepths(be.RIGHT, a), a = l.getDepth(be.LEFT)
                        }
                        return a
                    }
            ...
            Yn = function Wr() {
                ...
                var t = arguments[0];
                this._pts = t, this._orientation = Wr.orientation(t)
            };
        ...
        var Hn = function() {
            this._edges = new xt, this._ocaMap = new c
        };
        Hn.prototype.print = function(t) {
        ...
        Jn.prototype.isTrivialIntersection = function(t, e, n, i) {
            if (t === n && 1 === this._li.getIntersectionNum()) {
                if (Jn.isAdjacentSegments(e, i)) return !0;
                if (t.isClosed()) {
                    var r = t.size() - 1;
            ...
            return !1
        }, Jn.prototype.getProperIntersectionPoint = function() {
            return this._properIntersectionPoint
        }, Jn.prototype.hasProperInteriorIntersection = function() {
            return this._hasProperInterior
        }, Jn.prototype.getLineIntersector = function() {
            return this._li
        }, Jn.prototype.hasProperIntersection = function() {
            return this._hasProper
        }, Jn.prototype.processIntersections = function(t, e, n, i) {
            ...
            return !1
        }, Jn.prototype.hasInteriorIntersection = function() {
            return this._hasInterior
        }, Jn.prototype.interfaces_ = function() {
            return [Wn]
        }, Jn.prototype.getClass = function() {
            return Jn
        }, Jn.isAdjacentSegments = function(t, e) {
        ...
        Zn.prototype.print = function(t) {
            ...
            return this._nodeMap.values().iterator()
        }, Zn.prototype.addSplitEdges = function(t) {
            this.addEndpoints();
            for (var e = this.iterator(), n = e.next(); e.hasNext();) {
                var i = e.next(),
                    r = this.createSplitEdge(n, i);
        ...
        }, Zn.prototype.addEndpoints = function() {
            var t = this.edge.pts.length - 1;
            this.add(this.edge.pts[0], 0, 0), this.add(this.edge.pts[t], t, 0)
        }, Zn.prototype.createSplitEdge = function(t, e) {
            var n = e.segmentIndex - t.segmentIndex + 2,
        ...
        }, Zn.prototype.add = function(t, e, n) {
            var i = new Kn(t, e, n),
                r = this._nodeMap.get(i);
            return null !== r ? r : (this._nodeMap.put(i, i), i)
        }, Zn.prototype.isIntersection = function(t) {
            for (var e = this.iterator(); e.hasNext();)
        ...
        $n.prototype.getCoordinates = function() {
            ...
            if (4 === arguments.length) {
                ...
                if (this.env1.init(h, c), this.env2.init(p, f), !this.env1.intersects(this.env2)) return null;
        ...
        var ti = function Jr() {
                ...
                for (var t = 0; t < 2; t++)
                    for (var e = 0; e < 3; e++) this._depth[t][e] = Jr.NULL_VALUE
            },
            ei = {
                NULL_VALUE: {
                    configurable: !0
        ...
        ti.prototype.getDepth = function(t, e) {
            ...
            return this._depth[t][be.RIGHT] - this._depth[t][be.LEFT]
        ...
        var ni = function(t) {
                function e() {
                    if (t.call(this), this.pts = null, this._env = null, this.eiList = new Zn(this), this._name = null, this._mce = null, this._isIsolated = !0, this._depth = new ti, this._depthDelta = 0, 1 === arguments.length) {
                        var n = arguments[0];
                        e.call(this, n, null)
                    } else if (2 === arguments.length) {
                        var i = arguments[0],
                ...
                return t && (e.__proto__ = t), e.prototype = Object.create(t && t.prototype), e.prototype.constructor = e, e.prototype.getDepth = function() {
                    ...
                    var r = new N(t.getIntersection(i)),
                        o = e,
                    ...
                    var e = arguments[0],
                        n = arguments[1];
                    n.setAtLeastIfValid(e.getLocation(0, be.ON), e.getLocation(1, be.ON), 1), e.isArea() && (n.setAtLeastIfValid(e.getLocation(0, be.LEFT), e.getLocation(1, be.LEFT), 2), n.setAtLeastIfValid(e.getLocation(0, be.RIGHT), e.getLocation(1, be.RIGHT), 2))
                }, e
            }(ke),
            ii = function(t) {
        ...
        ii.prototype.setWorkingPrecisionModel = function(t) {
            ...
            for (var n = new xt, i = t.iterator(); i.hasNext();) {
                var r = i.next(),
            ...
            for (var e = new xt, n = t.getNodes().iterator(); n.hasNext();) {
                var i = n.next();
                if (!i.isVisited()) {
                    var r = new Oe;
                    r.create(i), e.add(r)
            ...
            var e = new Ln,
                n = new rt;
            return n.setPrecisionModel(t), e.setSegmentIntersector(new Jn(n)), e
        }, ii.prototype.buffer = function(t, e) {
            var n = this._workingPrecisionModel;
            null === n && (n = t.getPrecisionModel()), this._geomFact = t.getFactory();
            var i = new Dn(n, this._bufParams),
                r = new Bn(t, e, i).getCurves();
            if (r.size() <= 0) return this.createEmptyResultGeometry();
            this.computeNodedEdges(r, n), this._graph = new je(new Xn), this._graph.addEdges(this._edgeList.getEdges());
        ...
        ri.prototype.rescale = function() {
            if (O(arguments[0], Et))
                for (var t = arguments[0].iterator(); t.hasNext();) {
                    ...
                    2 === n.length && n[0].equals2D(n[1]) && j.out.println(n)
                }
        }, ri.prototype.scale = function() {
            if (O(arguments[0], Et)) {
                for (var t = arguments[0], e = new xt, n = t.iterator(); n.hasNext();) {
                    var i = n.next();
            ...
            if (arguments[0] instanceof Array) {
                for (var r = arguments[0], o = new Array(r.length).fill(null), s = 0; s < r.length; s++) o[s] = new N(Math.round((r[s].x - this._offsetX) * this._scaleFactor), Math.round((r[s].y - this._offsetY) * this._scaleFactor), r[s].z);
        ...
        oi.prototype.checkEndPtVertexIntersections = function() {
            ...
            if (0 === arguments.length)
                ...
                var g = h.getCoordinates()[c],
                    d = h.getCoordinates()[c + 1],
                    _ = p.getCoordinates()[f],
                    y = p.getCoordinates()[f + 1];
                if (this._li.computeIntersection(g, d, _, y), this._li.hasIntersection() && (this._li.isProper() || this.hasInteriorIntersection(this._li, g, d) || this.hasInteriorIntersection(this._li, _, y))) throw new $("found non-noded intersection at " + g + "-" + d + " and " + _ + "-" + y)
            }
        ...
        var pi = function(t) {
                ...
                var t = arguments[0];
                this._li = t, this._interiorIntersections = new xt
            };
        ...
        gi.prototype.checkCorrectness = function(t) {
            ...
            this._nodedSegStrings = t, this._noder = new Ln, this._pointSnapper = new hi(this._noder.getIndex()), this.snapRound(t, this._li)
        ...
        di.prototype.bufferFixedPrecision = function(t) {
            ...
            if (3 === arguments.length) {
                if (Number.isInteger(arguments[2]) && arguments[0] instanceof ht && "number" == typeof arguments[1]) {
                    var n = arguments[0],
                        i = arguments[1],
                        r = arguments[2],
                        o = new di(n);
                ...
                if (arguments[2] instanceof Nn && arguments[0] instanceof ht && "number" == typeof arguments[1]) {
                    var s = arguments[0],
                        a = arguments[1],
                        u = arguments[2];
                ...
                var l = arguments[0],
                    ...
                    p = arguments[3],
                    f = new di(l);
                return f.setQuadrantSegments(c), f.setEndCapStyle(p), f.getResultGeometry(h)
            }
        }, di.precisionScaleFactor = function(t, e, n) {
            var i = t.getEnvelopeInternal(),
                r = T.max(Math.abs(i.getMaxX()), Math.abs(i.getMaxY()), Math.abs(i.getMinX()), Math.abs(i.getMinY())) + 2 * (e > 0 ? e : 0),
                o = n - Math.trunc(Math.log(r) / Math.log(10) + 1);
            return Math.pow(10, o)
        }, _i.CAP_ROUND.get = function() {
            return Nn.CAP_ROUND
        }, _i.CAP_BUTT.get = function() {
            return Nn.CAP_FLAT
        }, _i.CAP_FLAT.get = function() {
            return Nn.CAP_FLAT
        }, _i.CAP_SQUARE.get = function() {
            return Nn.CAP_SQUARE
        }, _i.MAX_PRECISION_DIGITS.get = function() {
            return 12
        }, Object.defineProperties(di, _i);
        var yi = function() {
            this._pt = [new N, new N], this._distance = v.NaN, this._isNull = !0
        };
        yi.prototype.getCoordinates = function() {
            return this._pt
        }, yi.prototype.getCoordinate = function(t) {
            return this._pt[t]
        }, yi.prototype.setMinimum = function() {
            if (1 === arguments.length) {
                var t = arguments[0];
        ...
        }, yi.prototype.getDistance = function() {
            return this._distance
        }, yi.prototype.setMaximum = function() {
            if (1 === arguments.length) {
                var t = arguments[0];
        ...
        mi.prototype.interfaces_ = function() {
            ...
            if (arguments[2] instanceof yi && arguments[0] instanceof Jt && arguments[1] instanceof N)
                for (var t = arguments[0], e = arguments[1], n = arguments[2], i = t.getCoordinates(), r = new dn, o = 0; o < i.length - 1; o++) {
                    r.setCoordinates(i[o], i[o + 1]);
                    var s = r.closestPoint(e);
                    n.setMinimum(s, e)
                } else if (arguments[2] instanceof yi && arguments[0] instanceof $t && arguments[1] instanceof N) {
                    var a = arguments[0],
                        u = arguments[1],
                        l = arguments[2];
                    mi.computeDistance(a.getExteriorRing(), u, l);
                    for (var h = 0; h < a.getNumInteriorRing(); h++) mi.computeDistance(a.getInteriorRingN(h), u, l)
                } else if (arguments[2] instanceof yi && arguments[0] instanceof ht && arguments[1] instanceof N) {
                var c = arguments[0],
                    p = arguments[1],
                    f = arguments[2];
                if (c instanceof Jt) mi.computeDistance(c, p, f);
                else if (c instanceof $t) mi.computeDistance(c, p, f);
                else if (c instanceof Vt)
                    for (var g = c, d = 0; d < g.getNumGeometries(); d++) {
                        var _ = g.getGeometryN(d);
                        mi.computeDistance(_, p, f)
                    } else f.setMinimum(c.getCoordinate(), p)
            } else if (arguments[2] instanceof yi && arguments[0] instanceof dn && arguments[1] instanceof N) {
                var y = arguments[0],
                    m = arguments[1],
                    v = arguments[2],
                    E = y.closestPoint(m);
        ...
        var vi = function(t) {
                this._maxPtDist = new yi, this._inputGeom = t || null
            },
            Ei = {
        ...
        vi.prototype.computeMaxMidpointDistance = function(t) {
            ...
            return vi
        }, Ei.MaxPointDistanceFilter.get = function() {
            return Ii
        }, Ei.MaxMidpointDistanceFilter.get = function() {
            return Li
        }, Object.defineProperties(vi, Ei);
        var Ii = function(t) {
            this._maxPtDist = new yi, this._minPtDist = new yi, this._geom = t || null
        };
        ...
        Li.prototype.filter = function(t, e) {
            ...
            var n = t.getCoordinate(e - 1),
                i = t.getCoordinate(e),
                r = new N((n.x + i.x) / 2, (n.y + i.y) / 2);
            this._minPtDist.initialize(), mi.computeDistance(this._geom, r, this._minPtDist), this._maxPtDist.setMaximum(this._minPtDist)
        }, Li.prototype.isDone = function() {
            return !1
        }, Li.prototype.isGeometryChanged = function() {
            return !1
        }, Li.prototype.getMaxPointDistance = function() {
            return this._maxPtDist
        }, Li.prototype.interfaces_ = function() {
            return [Ut]
        }, Li.prototype.getClass = function() {
        ...
        xi.prototype.filter = function(t) {
            ...
            return xi
        }, xi.getPolygons = function() {
            if (1 === arguments.length) {
                var t = arguments[0];
                return xi.getPolygons(t, new xt)
            }
            if (2 === arguments.length) {
                var e = arguments[0],
                    n = arguments[1];
                return e instanceof $t ? n.add(e) : e instanceof Vt && e.apply(new xi(n)), n
            }
        };
        var Ni = function() {
        ...
        Ni.prototype.filter = function(t) {
            ...
            if (1 === arguments.length) {
                var t = arguments[0];
                return t.getFactory().buildGeometry(Ni.getLines(t))
            }
            if (2 === arguments.length) {
                var e = arguments[0],
                    n = arguments[1];
                return e.getFactory().buildGeometry(Ni.getLines(e, n))
            }
        }, Ni.getLines = function() {
            if (1 === arguments.length) {
                var t = arguments[0];
                return Ni.getLines(t, !1)
            }
            if (2 === arguments.length) {
                if (O(arguments[0], Et) && O(arguments[1], Et)) {
                ...
                if (arguments[0] instanceof ht && "boolean" == typeof arguments[1]) {
                    var o = arguments[0],
                        s = arguments[1],
                        a = new xt;
                    return o.apply(new Ni(a, s)), a
                }
                if (arguments[0] instanceof ht && O(arguments[1], Et)) {
                    var u = arguments[0],
                        l = arguments[1];
                    return u instanceof Jt ? l.add(u) : u.apply(new Ni(l)), l
                }
            } else if (3 === arguments.length) {
                if ("boolean" == typeof arguments[2] && O(arguments[0], Et) && O(arguments[1], Et)) {
                    for (var h = arguments[0], c = arguments[1], p = arguments[2], f = h.iterator(); f.hasNext();) {
                        var g = f.next();
                        Ni.getLines(g, c, p)
                    }
                    return c
                }
                if ("boolean" == typeof arguments[2] && arguments[0] instanceof ht && O(arguments[1], Et)) {
                    var d = arguments[0],
                        _ = arguments[1],
                        y = arguments[2];
                    return d.apply(new Ni(_, y)), _
                }
            }
        };
        var bi = function() {
        ...
        bi.prototype.locateInternal = function() {
            if (arguments[0] instanceof N && arguments[1] instanceof $t) {
                var t = arguments[0],
                    e = arguments[1];
            ...
            if (arguments[0] instanceof N && arguments[1] instanceof Zt) {
                var h = arguments[0];
                return arguments[1].getCoordinate().equals2D(h) ? w.INTERIOR : w.EXTERIOR
            }
        }, bi.prototype.locateInPolygonRing = function(t, e) {
            return e.getEnvelopeInternal().intersects(t) ? at.locatePointInRing(t, e.getCoordinates()) : w.EXTERIOR
        }, bi.prototype.intersects = function(t, e) {
            return this.locate(t, e) !== w.EXTERIOR
        }, bi.prototype.updateLocationInfo = function(t) {
            t === w.INTERIOR && (this._isIn = !0), t === w.BOUNDARY && this._numBoundaries++
        }, bi.prototype.computeLocation = function(t, e) {
            if (e instanceof Zt && this.updateLocationInfo(this.locateInternal(t, e)), e instanceof Jt) this.updateLocationInfo(this.locateInternal(t, e));
        ...
        }, bi.prototype.locate = function(t, e) {
            return e.isEmpty() ? w.EXTERIOR : e instanceof Jt ? this.locateInternal(t, e) : e instanceof $t ? this.locateInternal(t, e) : (this._isIn = !1, this._numBoundaries = 0, this.computeLocation(t, e), this._boundaryRule.isInBoundary(this._numBoundaries) ? w.BOUNDARY : this._numBoundaries > 0 || this._isIn ? w.INTERIOR : w.EXTERIOR)
        ...
        var Ci = function Kr() {
                if (this._component = null, this._segIndex = null, this._pt = null, 2 === arguments.length) {
                    var t = arguments[0],
                        e = arguments[1];
                    Kr.call(this, t, Kr.INSIDE_AREA, e)
                } else if (3 === arguments.length) {
                    var n = arguments[0],
                        i = arguments[1],
                        r = arguments[2];
        ...
        Ci.prototype.isInsideArea = function() {
            ...
            return Ci
        }, Si.INSIDE_AREA.get = function() {
            return -1
        }, Object.defineProperties(Ci, Si);
        var wi = function(t) {
            this._pts = t || null
        };
        wi.prototype.filter = function(t) {
            t instanceof Zt && this._pts.add(t)
            ...
            if (1 === arguments.length) {
                var t = arguments[0];
                return t instanceof Zt ? $e.singletonList(t) : wi.getPoints(t, new xt)
            }
            if (2 === arguments.length) {
                var e = arguments[0],
                    n = arguments[1];
                return e instanceof Zt ? n.add(e) : e instanceof Vt && e.apply(new wi(n)), n
            }
        };
        var Mi = function() {
        ...
        Mi.prototype.filter = function(t) {
            (t instanceof Zt || t instanceof Jt || t instanceof $t) && this._locations.add(new Ci(t, 0, t.getCoordinate()))
        }, Mi.prototype.interfaces_ = function() {
            return [qt]
        }, Mi.prototype.getClass = function() {
            return Mi
        }, Mi.getLocations = function(t) {
            var e = new xt;
            return t.apply(new Mi(e)), e
        };
        var Oi = function() {
            if (this._geom = null, this._terminateDistance = 0, this._ptLocator = new bi, this._minDistanceLocation = null, this._minDistance = v.MAX_VALUE, 2 === arguments.length) {
                var t = arguments[0],
                    e = arguments[1];
        ...
        Oi.prototype.computeContainmentDistance = function() {
            if (0 === arguments.length) {
                var t = new Array(2).fill(null);
                ...
                var e = arguments[0],
                    n = arguments[1],
                    i = 1 - e,
                    r = xi.getPolygons(this._geom[e]);
                if (r.size() > 0) {
                    var o = Mi.getLocations(this._geom[i]);
                ...
                if (arguments[2] instanceof Array && O(arguments[0], Lt) && O(arguments[1], Lt)) {
                    for (var s = arguments[0], a = arguments[1], u = arguments[2], l = 0; l < s.size(); l++)
                        for (var h = s.get(l), c = 0; c < a.size(); c++)
                            if (this.computeContainmentDistance(h, a.get(c), u), this._minDistance <= this._terminateDistance) return null
                } else if (arguments[2] instanceof Array && arguments[0] instanceof Ci && arguments[1] instanceof $t) {
                var p = arguments[0],
                    f = arguments[1],
                    g = arguments[2],
                    d = p.getCoordinate();
                if (w.EXTERIOR !== this._ptLocator.locate(d, f)) return this._minDistance = 0, g[0] = p, g[1] = new Ci(f, d), null
            }
        }, Oi.prototype.computeMinDistanceLinesPoints = function(t, e, n) {
        ...
        }, Oi.prototype.computeFacetDistance = function() {
            var t = new Array(2).fill(null),
                e = Ni.getLines(this._geom[0]),
                n = Ni.getLines(this._geom[1]),
        ...
        }, Oi.prototype.nearestLocations = function() {
            return this.computeMinDistance(), this._minDistanceLocation
        }, Oi.prototype.updateMinDistance = function(t, e) {
            ...
            if (0 === arguments.length) {
                ...
                if (arguments[2] instanceof Array && arguments[0] instanceof Jt && arguments[1] instanceof Zt) {
                    var t = arguments[0],
                        e = arguments[1],
                        n = arguments[2];
                ...
                } else if (arguments[2] instanceof Array && arguments[0] instanceof Jt && arguments[1] instanceof Jt) {
                var u = arguments[0],
                    l = arguments[1],
                    h = arguments[2];
                if (u.getEnvelopeInternal().distance(l.getEnvelopeInternal()) > this._minDistance) return null;
                for (var c = u.getCoordinates(), p = l.getCoordinates(), f = 0; f < c.length - 1; f++)
                    for (var g = 0; g < p.length - 1; g++) {
                        var d = at.distanceLineLine(c[f], c[f + 1], p[g], p[g + 1]);
                        if (d < this._minDistance) {
                            this._minDistance = d;
                            var _ = new dn(c[f], c[f + 1]),
                                y = new dn(p[g], p[g + 1]),
                                m = _.closestPoints(y);
                            h[0] = new Ci(u, f, m[0]), h[1] = new Ci(l, g, m[1])
                        }
                        if (this._minDistance <= this._terminateDistance) return null
                    }
            }
        }, Oi.prototype.computeMinDistancePoints = function(t, e, n) {
            for (var i = 0; i < t.size(); i++)
                for (var r = t.get(i), o = 0; o < e.size(); o++) {
                    var s = e.get(o),
                        a = r.getCoordinate().distance(s.getCoordinate());
                    if (a < this._minDistance && (this._minDistance = a, n[0] = new Ci(r, 0, r.getCoordinate()), n[1] = new Ci(s, 0, s.getCoordinate())), this._minDistance <= this._terminateDistance) return null
                }
        }, Oi.prototype.distance = function() {
            if (null === this._geom[0] || null === this._geom[1]) throw new m("null geometries are not supported");
            return this._geom[0].isEmpty() || this._geom[1].isEmpty() ? 0 : (this.computeMinDistance(), this._minDistance)
        }, Oi.prototype.computeMinDistanceLines = function(t, e, n) {
            for (var i = 0; i < t.size(); i++)
                for (var r = t.get(i), o = 0; o < e.size(); o++) {
                    var s = e.get(o);
                    if (this.computeMinDistance(r, s, n), this._minDistance <= this._terminateDistance) return null
            ...
            return Oi
        }, Oi.distance = function(t, e) {
            return new Oi(t, e).distance()
        }, Oi.isWithinDistance = function(t, e, n) {
            return new Oi(t, e, n).distance() <= n
        }, Oi.nearestPoints = function(t, e) {
            return new Oi(t, e).nearestPoints()
        };
        var Ti = function() {
            this._pt = [new N, new N], this._distance = v.NaN, this._isNull = !0
        };
        ...
        Pi.prototype.interfaces_ = function() {
            ...
            if (arguments[2] instanceof Ti && arguments[0] instanceof Jt && arguments[1] instanceof N)
                for (var t = arguments[0], e = arguments[1], n = arguments[2], i = new dn, r = t.getCoordinates(), o = 0; o < r.length - 1; o++) {
                    ...
                    n.setMinimum(s, e)
                } else if (arguments[2] instanceof Ti && arguments[0] instanceof $t && arguments[1] instanceof N) {
                    var a = arguments[0],
                        u = arguments[1],
                        l = arguments[2];
                    Pi.computeDistance(a.getExteriorRing(), u, l);
                    for (var h = 0; h < a.getNumInteriorRing(); h++) Pi.computeDistance(a.getInteriorRingN(h), u, l)
                } else if (arguments[2] instanceof Ti && arguments[0] instanceof ht && arguments[1] instanceof N) {
                var c = arguments[0],
                    p = arguments[1],
                    f = arguments[2];
                if (c instanceof Jt) Pi.computeDistance(c, p, f);
                else if (c instanceof $t) Pi.computeDistance(c, p, f);
                else if (c instanceof Vt)
                    for (var g = c, d = 0; d < g.getNumGeometries(); d++) {
                        var _ = g.getGeometryN(d);
                        Pi.computeDistance(_, p, f)
                    } else f.setMinimum(c.getCoordinate(), p)
            } else if (arguments[2] instanceof Ti && arguments[0] instanceof dn && arguments[1] instanceof N) {
                var y = arguments[0],
                    m = arguments[1],
                    v = arguments[2],
                    E = y.closestPoint(m);
        ...
        }, Ri.prototype.setDensifyFraction = function(t) {
            if (t > 1 || t <= 0) throw new m("Fraction is not in range (0.0 - 1.0]");
            this._densifyFrac = t
        }, Ri.prototype.compute = function(t, e) {
        ...
        }, Ri.prototype.computeOrientedDistance = function(t, e, n) {
            var i = new Ai(e);
        ...
        }, Ri.prototype.orientedDistance = function() {
            return this.computeOrientedDistance(this._g0, this._g1, this._ptDist), this._ptDist.getDistance()
        }, Ri.prototype.interfaces_ = function() {
            return []
        }, Ri.prototype.getClass = function() {
            return Ri
        }, Ri.distance = function() {
            if (2 === arguments.length) {
                var t = arguments[0],
                    e = arguments[1];
                return new Ri(t, e).distance()
            }
            if (3 === arguments.length) {
                var n = arguments[0],
                    i = arguments[1],
        ...
        var Ai = function() {
            this._maxPtDist = new Ti, this._minPtDist = new Ti, this._euclideanDist = new Pi, this._geom = null;
            var t = arguments[0];
            this._geom = t
        };
        ...
        Fi.prototype.checkMaximumDistance = function(t, e, n) {
            ...
            if (i.setDensifyFraction(.25), this._maxDistanceFound = i.orientedDistance(), this._maxDistanceFound > n) {
                ...
                this._errorLocation = r[1], this._errorIndicator = t.getFactory().createLineString(r), this._errMsg = "Distance between buffer curve and input is too large (" + this._maxDistanceFound + " at " + Q.toLineString(r[0], r[1]) + ")"
            }
            ...
            if (!(this._input instanceof $t || this._input instanceof ne || this._input instanceof Vt)) return null;
            ...
            if (this._minDistanceFound = i.distance(), this._minDistanceFound < n) {
                ...
                this._errorLocation = i.nearestPoints()[1], this._errorIndicator = t.getFactory().createLineString(r), this._errMsg = "Distance between buffer curve and input is too small (" + this._minDistanceFound + " at " + Q.toLineString(r[0], r[1]) + " )"
            }
            ...
            for (var e = new xt, n = new Ni(e), i = xi.getPolygons(t).iterator(); i.hasNext();) i.next().apply(n);
        ...
        Bi.prototype.isValid = function() {
            ...
            j.out.println("Check " + t + ": " + (this._isValid ? "passed" : "FAILED"))
            ...
            return !1
        }, qi.MAX_ENV_DIFF_FRAC.get = function() {
            return .012
        }, Object.defineProperties(Bi, qi);
        var Ui = function() {
        ...
        var Vi = function() {
            this._findAllIntersections = !1, this._isCheckEndSegmentsOnly = !1, this._li = null, this._interiorIntersection = null, this._intSegments = null, this._intersections = new xt, this._intersectionCount = 0, this._keepIntersections = !0;
            var t = arguments[0];
            this._li = t, this._interiorIntersection = null
        };
        Vi.prototype.getInteriorIntersection = function() {
            return this._interiorIntersection
        }, Vi.prototype.setCheckEndSegmentsOnly = function(t) {
            this._isCheckEndSegmentsOnly = t
        }, Vi.prototype.getIntersectionSegments = function() {
            return this._intSegments
        }, Vi.prototype.count = function() {
            return this._intersectionCount
        }, Vi.prototype.getIntersections = function() {
            return this._intersections
        }, Vi.prototype.setFindAllIntersections = function(t) {
            this._findAllIntersections = t
        }, Vi.prototype.setKeepIntersections = function(t) {
            this._keepIntersections = t
        }, Vi.prototype.processIntersections = function(t, e, n, i) {
        ...
        }, Vi.prototype.isEndSegment = function(t, e) {
            return 0 === e || e >= t.size() - 2
        }, Vi.prototype.hasIntersection = function() {
            return null !== this._interiorIntersection
        }, Vi.prototype.isDone = function() {
            return !this._findAllIntersections && null !== this._interiorIntersection
        }, Vi.prototype.interfaces_ = function() {
            return [Wn]
        }, Vi.prototype.getClass = function() {
            return Vi
        }, Vi.createAllIntersectionsFinder = function(t) {
            var e = new Vi(t);
            return e.setFindAllIntersections(!0), e
        }, Vi.createAnyIntersectionFinder = function(t) {
            return new Vi(t)
        }, Vi.createIntersectionCounter = function(t) {
            var e = new Vi(t);
        ...
        zi.prototype.execute = function() {
            if (null !== this._segInt) return null;
            this.checkInteriorIntersections()
        }, zi.prototype.getIntersections = function() {
            return this._segInt.getIntersections()
        }, zi.prototype.isValid = function() {
            return this.execute(), this._isValid
        }, zi.prototype.setFindAllIntersections = function(t) {
            this._findAllIntersections = t
        }, zi.prototype.checkInteriorIntersections = function() {
            this._isValid = !0, this._segInt = new Vi(this._li), this._segInt.setFindAllIntersections(this._findAllIntersections);
            var t = new Ln;
        ...
        }, zi.prototype.getErrorMessage = function() {
            ...
            return zi
        }, zi.computeIntersections = function(t) {
            var e = new zi(t);
        ...
        var ji = function Zr() {
            this._nv = null;
            var t = arguments[0];
            this._nv = new zi(Zr.toSegmentStrings(t))
        };
        ji.prototype.checkValid = function() {
            ...
            return ji
        }, ji.toSegmentStrings = function(t) {
            for (var e = new xt, n = t.iterator(); n.hasNext();) {
                var i = n.next();
                e.add(new Ui(i.getCoordinates(), i))
            }
            return e
        }, ji.checkValid = function(t) {
            new ji(t).checkValid()
        };
        var Xi = function(t) {
            this._mapOp = t
        ...
        Xi.prototype.map = function(t) {
            for (var e = new xt, n = 0; n < t.getNumGeometries(); n++) {
                var i = this._mapOp.map(t.getGeometryN(n));
                i.isEmpty() || e.add(i)
            }
            return t.getFactory().createGeometryCollection(ye.toGeometryArray(e))
        }, Xi.prototype.interfaces_ = function() {
            return []
        }, Xi.prototype.getClass = function() {
            return Xi
        }, Xi.map = function(t, e) {
            return new Xi(e).map(t)
        };
        var Yi = function() {
            this._op = null, this._geometryFactory = null, this._ptLocator = null, this._lineEdgesList = new xt, this._resultLineList = new xt;
            var t = arguments[0],
                e = arguments[1],
                n = arguments[2];
        ...
        Yi.prototype.collectLines = function(t) {
            ...
            var i = t.getLabel(),
                r = t.getEdge();
            t.isLineEdge() && (t.isVisited() || !Cr.isResultOfOp(i, e) || r.isCovered() || (n.add(r), t.setVisitedEdge(!0)))
            ...
            var i = t.getLabel();
            return t.isLineEdge() ? null : t.isVisited() ? null : t.isInteriorAreaEdge() ? null : t.getEdge().isInResult() ? null : (et.isTrue(!(t.isInResult() || t.getSym().isInResult()) || !t.getEdge().isInResult()), void(Cr.isResultOfOp(i, e) && e === Cr.INTERSECTION && (n.add(t.getEdge()), t.setVisitedEdge(!0))))
        }, Yi.prototype.interfaces_ = function() {
            return []
        }, Yi.prototype.getClass = function() {
            return Yi
        ...
        var Hi = function() {
            this._op = null, this._geometryFactory = null, this._resultPointList = new xt;
            var t = arguments[0],
                e = arguments[1];
        ...
        Hi.prototype.filterCoveredNodeToPoint = function(t) {
            ...
            for (var e = this._op.getGraph().getNodes().iterator(); e.hasNext();) {
                var n = e.next();
                if (!(n.isInResult() || n.isIncidentEdgeInResult() || 0 !== n.getEdges().getDegree() && t !== Cr.INTERSECTION)) {
                    var i = n.getLabel();
        ...
        Wi.prototype.transformPoint = function(t, e) {
            ...
            for (var r = new xt, o = 0; o < t.getNumInteriorRing(); o++) {
            ...
            for (var n = new xt, i = 0; i < t.getNumGeometries(); i++) {
            ...
            return this._preserveGeometryCollectionType ? this._factory.createGeometryCollection(ye.toGeometryArray(n)) : this._factory.buildGeometry(n)
        }, Wi.prototype.transform = function(t) {
            if (this._inputGeom = t, this._factory = t.getFactory(), t instanceof Zt) return this.transformPoint(t, null);
            ...
            if (t instanceof zt) return this.transformMultiLineString(t, null);
            if (t instanceof $t) return this.transformPolygon(t, null);
            if (t instanceof ne) return this.transformMultiPolygon(t, null);
            if (t instanceof Vt) return this.transformGeometryCollection(t, null);
        ...
        var Ji = function Qr() {
            if (this._snapTolerance = 0, this._srcPts = null, this._seg = new dn, this._allowSnappingToSourceVertices = !1, this._isClosed = !1, arguments[0] instanceof Jt && "number" == typeof arguments[1]) {
                var t = arguments[0],
                    e = arguments[1];
                Qr.call(this, t.getCoordinates(), e)
            } else if (arguments[0] instanceof Array && "number" == typeof arguments[1]) {
                var n = arguments[0],
                    i = arguments[1];
                this._srcPts = n, this._isClosed = Qr.isClosed(n), this._snapTolerance = i
            }
        };
        Ji.prototype.snapVertices = function(t, e) {
            for (var n = this._isClosed ? t.size() - 1 : t.size(), i = 0; i < n; i++) {
                var r = t.get(i),
                    o = this.findSnapForVertex(r, e);
                null !== o && (t.set(i, new N(o)), 0 === i && this._isClosed && t.set(t.size() - 1, new N(o)))
            }
        }, Ji.prototype.findSnapForVertex = function(t, e) {
            for (var n = 0; n < e.length; n++) {
                if (t.equals2D(e[n])) return null;
                if (t.distance(e[n]) < this._snapTolerance) return e[n]
            }
            return null
        }, Ji.prototype.snapTo = function(t) {
            var e = new bt(this._srcPts);
            return this.snapVertices(e, t), this.snapSegments(e, t), e.toCoordinateArray()
        }, Ji.prototype.snapSegments = function(t, e) {
            ...
            for (var i = 0; i < n; i++) {
                ...
                o >= 0 && t.add(o + 1, new N(r), !1)
            }
        }, Ji.prototype.findSegmentIndexToSnap = function(t, e) {
            ...
            return i
        }, Ji.prototype.setAllowSnappingToSourceVertices = function(t) {
            this._allowSnappingToSourceVertices = t
        }, Ji.prototype.interfaces_ = function() {
            return []
        }, Ji.prototype.getClass = function() {
            return Ji
        }, Ji.isClosed = function(t) {
        ...
        Ki.prototype.snapTo = function(t, e) {
            ...
            var n = this.extractTargetCoordinates(this._srcGeom),
                ...
                r = i;
            return e && O(r, Qt) && (r = i.buffer(0)), r
            ...
            if (1 === arguments.length) {
                var t = arguments[0],
                    e = Ki.computeSizeBasedSnapTolerance(t),
            ...
            if (2 === arguments.length) {
                var r = arguments[0],
                    o = arguments[1];
                return Math.min(Ki.computeOverlaySnapTolerance(r), Ki.computeOverlaySnapTolerance(o))
            }
        }, Ki.computeSizeBasedSnapTolerance = function(t) {
            var e = t.getEnvelopeInternal();
            return Math.min(e.getHeight(), e.getWidth()) * Ki.SNAP_PRECISION_FACTOR
        }, Ki.snapToSelf = function(t, e, n) {
            return new Ki(t).snapToSelf(e, n)
        }, Zi.SNAP_PRECISION_FACTOR.get = function() {
            return 1e-9
        }, Object.defineProperties(Ki, Zi);
        var Qi = function(t) {
                function e(e, n, i) {
                ...
                return t && (e.__proto__ = t), e.prototype = Object.create(t && t.prototype), e.prototype.constructor = e, e.prototype.snapLine = function(t, e) {
                    var n = new Ji(t, this._snapTolerance);
        ...
        rr.prototype.selfSnap = function(t) {
            ...
            t.isValid() || j.out.println("Snapped geometry is invalid")
            ...
            return Ki.snap(e[0], e[1], this._snapTolerance)
        ...
        var ar = function $r() {
                if (this._label = null, this._xValue = null, this._eventType = null, this._insertEvent = null, this._deleteEventIndex = null, this._obj = null, 2 === arguments.length) {
                    ...
                    var n = arguments[0],
                        i = arguments[1],
                        r = arguments[2];
                    this._eventType = $r.INSERT, this._label = n, this._xValue = i, this._obj = r
                }
            },
            ur = {
                INSERT: {
        ...
        var cr = function(t) {
                function e() {
                    t.call(this), this.events = new xt, this.nOverlaps = null
                }
                return t && (e.__proto__ = t), e.prototype = Object.create(t && t.prototype), e.prototype.constructor = e, e.prototype.prepareEvents = function() {
                    ...
                    if (1 === arguments.length) {
                        ...
                        if (arguments[2] instanceof hr && O(arguments[0], Lt) && O(arguments[1], Lt)) {
                            var i = arguments[0],
                                r = arguments[1],
                                o = arguments[2];
                            this.addEdges(i, i), this.addEdges(r, r), this.computeIntersections(o)
                        } else if ("boolean" == typeof arguments[2] && O(arguments[0], Lt) && arguments[1] instanceof hr) {
                        var s = arguments[0],
                            a = arguments[1];
        ...
        var dr = function(t) {
            ...
            yr = function() {
                this._leaves = new xt, this._root = null, this._level = 0
            };
        yr.prototype.buildTree = function() {
            $e.sort(this._leaves, new pr.NodeComparator);
            for (var t = this._leaves, e = null, n = new xt;;) {
                if (this.buildLevel(t, n), 1 === n.size()) return n.get(0);
                e = t, t = n, n = e
            }
        }, yr.prototype.insert = function(t, e, n) {
            if (null !== this._root) throw new Error("Index cannot be added to once it has been queried");
            this._leaves.add(new dr(t, e, n))
        }, yr.prototype.query = function(t, e, n) {
            this.init(), this._root.query(t, e, n)
        }, yr.prototype.buildRoot = function() {
            if (null !== this._root) return null;
            this._root = this.buildTree()
        }, yr.prototype.printNode = function(t) {
            j.out.println(Q.toLineString(new N(t._min, this._level), new N(t._max, this._level)))
        }, yr.prototype.init = function() {
            if (null !== this._root) return null;
            this.buildRoot()
        }, yr.prototype.buildLevel = function(t, e) {
            this._level++, e.clear();
            for (var n = 0; n < t.size(); n += 2) {
                var i = t.get(n);
                if (null === (n + 1 < t.size() ? t.get(n) : null)) e.add(i);
                else {
                    var r = new _r(t.get(n), t.get(n + 1));
                    e.add(r)
                }
            }
        ...
        var vr = function() {
                this._index = null;
                var t = arguments[0];
                if (!O(t, Qt)) throw new m("Argument must be Polygonal");
                this._index = new Lr(t)
            },
            Er = {
                SegmentVisitor: {
                    configurable: !0
        ...
        vr.prototype.locate = function(t) {
            ...
            return vr
        }, Er.SegmentVisitor.get = function() {
            return Ir
        }, Er.IntervalIndexedGeometry.get = function() {
            return Lr
        }, Object.defineProperties(vr, Er);
        var Ir = function() {
            this._counter = null;
            var t = arguments[0];
            this._counter = t
        };
        Ir.prototype.visitItem = function(t) {
            var e = t;
        ...
        }, Lr.prototype.addLine = function(t) {
            for (var e = 1; e < t.length; e++) {
        ...
        var xr = function(t) {
                function e() {
                    if (t.call(this), this._parentGeom = null, this._lineEdgeMap = new pe, this._boundaryNodeRule = null, this._useBoundaryDeterminationRule = !0, this._argIndex = null, this._boundaryNodes = null, this._hasTooFewPoints = !1, this._invalidPoint = null, this._areaPtLocator = null, this._ptLocator = new bi, 2 === arguments.length) {
                        var e = arguments[0],
                            n = arguments[1],
                ...
                return t && (e.__proto__ = t), e.prototype = Object.create(t && t.prototype), e.prototype.constructor = e, e.prototype.insertBoundaryPoint = function(t, n) {
                    var i = this._nodes.addNode(n).getLabel(),
                        r = 1;
                    w.NONE, i.getLocation(t, be.ON) === w.BOUNDARY && r++;
                    ...
                    if (e instanceof ne && (this._useBoundaryDeterminationRule = !1), e instanceof $t) this.addPolygon(e);
                    ...
                    else if (e instanceof Zt) this.addPoint(e);
                        ...
                        if (!(e instanceof Vt)) throw new Error(e.getClass().getName());
                    ...
                    return O(this._parentGeom, Qt) && this._parentGeom.getNumGeometries() > 50 ? (null === this._areaPtLocator && (this._areaPtLocator = new vr(this._parentGeom)), this._areaPtLocator.locate(t)) : this._ptLocator.locate(t, this._parentGeom)
            ...
            Nr = function() {
                if (this._li = new rt, this._resultPrecisionModel = null, this._arg = null, 1 === arguments.length) {
                    var t = arguments[0];
                    this.setComputationPrecision(t.getPrecisionModel()), this._arg = new Array(1).fill(null), this._arg[0] = new xr(0, t)
                } else if (2 === arguments.length) {
                    var e = arguments[0],
                        n = arguments[1],
                        i = gt.OGC_SFS_BOUNDARY_RULE;
                    e.getPrecisionModel().compareTo(n.getPrecisionModel()) >= 0 ? this.setComputationPrecision(e.getPrecisionModel()) : this.setComputationPrecision(n.getPrecisionModel()), this._arg = new Array(2).fill(null), this._arg[0] = new xr(0, e, i), this._arg[1] = new xr(1, n, i)
                } else if (3 === arguments.length) {
                    var r = arguments[0],
                        o = arguments[1],
                        s = arguments[2];
                    r.getPrecisionModel().compareTo(o.getPrecisionModel()) >= 0 ? this.setComputationPrecision(r.getPrecisionModel()) : this.setComputationPrecision(o.getPrecisionModel()), this._arg = new Array(2).fill(null), this._arg[0] = new xr(0, r, s), this._arg[1] = new xr(1, o, s)
                }
            };
        ...
        br.prototype.interfaces_ = function() {
            ...
            if (arguments[0] instanceof ht && O(arguments[1], br.MapOp)) {
                for (var t = arguments[0], e = arguments[1], n = new xt, i = 0; i < t.getNumGeometries(); i++) {
                    var r = e.map(t.getGeometryN(i));
                    null !== r && n.add(r)
                }
                return t.getFactory().buildGeometry(n)
            }
            if (O(arguments[0], Et) && O(arguments[1], br.MapOp)) {
                for (var o = arguments[0], s = arguments[1], a = new xt, u = o.iterator(); u.hasNext();) {
                    var l = u.next(),
                        h = s.map(l);
                    null !== h && a.add(h)
                }
        ...
        var Cr = function(t) {
            function e() {
                var e = arguments[0],
                    n = arguments[1];
                t.call(this, e, n), this._ptLocator = new bi, this._geomFact = null, this._resultGeom = null, this._graph = null, this._edgeList = new Hn, this._resultPolyList = new xt, this._resultLineList = new xt, this._resultPointList = new xt, this._graph = new je(new Xn), this._geomFact = e.getFactory()
            }
            return t && (e.__proto__ = t), e.prototype = Object.create(t && t.prototype), e.prototype.constructor = e, e.prototype.insertUniqueEdge = function(t) {
                ...
                for (var t = new xt, e = this._edgeList.iterator(); e.hasNext();) {
                    var n = e.next();
                ...
                var e = new xt;
                this._arg[0].computeSplitEdges(e), this._arg[1].computeSplitEdges(e), this.insertUniqueEdges(e), this.computeLabelsFromDepths(), this.replaceCollapsedEdges(), ji.checkValid(this._edgeList.getEdges()), this._graph.addEdges(this._edgeList.getEdges()), this.computeLabelling(), this.labelIncompleteNodes(), this.findResultAreaEdges(t), this.cancelDuplicateResultEdges();
                ...
                for (var n = this._graph.getEdgeEnds().iterator(); n.hasNext();) {
                    var i = n.next(),
                        r = i.getLabel();
                    r.isArea() && !i.isInteriorAreaEdge() && e.isResultOfOp(r.getLocation(0, be.RIGHT), r.getLocation(1, be.RIGHT), t) && i.setInResult(!0)
                }
                ...
                for (var t = this._edgeList.iterator(); t.hasNext();) {
                    ...
                    if (!i.isNull()) {
                        i.normalize();
                        for (var r = 0; r < 2; r++) n.isNull(r) || !n.isArea() || i.isNull(r) || (0 === i.getDelta(r) ? n.toLine(r) : (et.isTrue(!i.isNull(r, be.LEFT), "depth of LEFT side has not been initialized"), n.setLocation(r, be.LEFT, i.getLocation(r, be.LEFT)), et.isTrue(!i.isNull(r, be.RIGHT), "depth of RIGHT side has not been initialized"), n.setLocation(r, be.RIGHT, i.getLocation(r, be.RIGHT))))
                    }
                }
        ...
        Cr.overlayOp = function(t, e, n) {
            ...
            if (t.isEmpty() || e.isEmpty()) return Cr.createEmptyResult(Cr.INTERSECTION, t, e, t.getFactory());
            ...
            return t.checkNotGeometryCollection(t), t.checkNotGeometryCollection(e), or.overlayOp(t, e, Cr.INTERSECTION)
        }, Cr.symDifference = function(t, e) {
            if (t.isEmpty() || e.isEmpty()) {
                if (t.isEmpty() && e.isEmpty()) return Cr.createEmptyResult(Cr.SYMDIFFERENCE, t, e, t.getFactory());
                if (t.isEmpty()) return e.copy();
                if (e.isEmpty()) return t.copy()
            }
            return t.checkNotGeometryCollection(t), t.checkNotGeometryCollection(e), or.overlayOp(t, e, Cr.SYMDIFFERENCE)
            ...
            return t.isEmpty() ? Cr.createEmptyResult(Cr.DIFFERENCE, t, e, t.getFactory()) : e.isEmpty() ? t.copy() : (t.checkNotGeometryCollection(t), t.checkNotGeometryCollection(e), or.overlayOp(t, e, Cr.DIFFERENCE))
        ...
        var Sr = function() {
            this._g = null, this._boundaryDistanceTolerance = null, this._linework = null, this._ptLocator = new bi, this._seg = new dn;
            var t = arguments[0],
                e = arguments[1];
        ...
        var wr = function() {
            this._linework = null, this._linework = new xt
        };
        ...
        Mr.prototype.extractPoints = function(t, e, n) {
            for (var i = t.getCoordinates(), r = 0; r < i.length - 1; r++) this.computeOffsetPoints(i[r], i[r + 1], e, n)
        }, Mr.prototype.setSidesToGenerate = function(t, e) {
            this._doLeft = t, this._doRight = e
        }, Mr.prototype.getPoints = function(t) {
            for (var e = new xt, n = Ni.getLines(this._g).iterator(); n.hasNext();) {
                var i = n.next();
                this.extractPoints(i, t, e)
            }
            return e
        }, Mr.prototype.computeOffsetPoints = function(t, e, n, i) {
            var r = e.x - t.x,
                o = e.y - t.y,
                s = Math.sqrt(r * r + o * o),
                a = n * r / s,
        ...
        var Or = function to() {
                this._geom = null, this._locFinder = null, this._location = new Array(3).fill(null), this._invalidLocation = null, this._boundaryDistanceTolerance = to.TOLERANCE, this._testCoords = new xt;
                var t = arguments[0],
                    e = arguments[1],
                    n = arguments[2];
                this._boundaryDistanceTolerance = to.computeBoundaryDistanceTolerance(t, e), this._geom = [t, e, n], this._locFinder = [new Sr(this._geom[0], this._boundaryDistanceTolerance), new Sr(this._geom[1], this._boundaryDistanceTolerance), new Sr(this._geom[2], this._boundaryDistanceTolerance)]
            },
            Tr = {
                TOLERANCE: {
                    configurable: !0
        ...
        Or.prototype.reportResult = function(t, e, n) {
            j.out.println("Overlay result invalid - A:" + w.toLocationSymbol(e[0]) + " B:" + w.toLocationSymbol(e[1]) + " expected:" + (n ? "i" : "e") + " actual:" + w.toLocationSymbol(e[2]))
        }, Or.prototype.isValid = function(t) {
            this.addTestPts(this._geom[0]), this.addTestPts(this._geom[1]);
            return this.checkValid(t)
            ...
            if (2 === arguments.length) {
                var i = arguments[0],
                    r = arguments[1];
                return this._location[0] = this._locFinder[0].getLocation(r), this._location[1] = this._locFinder[1].getLocation(r), this._location[2] = this._locFinder[2].getLocation(r), !!Or.hasLocation(this._location, w.BOUNDARY) || this.isValidResult(i, this._location)
            }
        }, Or.prototype.addTestPts = function(t) {
            var e = new Mr(t);
            this._testCoords.addAll(e.getPoints(5 * this._boundaryDistanceTolerance))
        }, Or.prototype.isValidResult = function(t, e) {
            var n = Cr.isResultOfOp(e[0], e[1], t),
                i = !(n ^ e[2] === w.INTERIOR);
            return i || this.reportResult(t, e, n), i
        }, Or.prototype.getInvalidLocation = function() {
            return this._invalidLocation
        }, Or.prototype.interfaces_ = function() {
            return []
        }, Or.prototype.getClass = function() {
            return Or
        }, Or.hasLocation = function(t, e) {
            for (var n = 0; n < 3; n++)
                if (t[n] === e) return !0;
            return !1
        }, Or.computeBoundaryDistanceTolerance = function(t, e) {
            return Math.min(Ki.computeSizeBasedSnapTolerance(t), Ki.computeSizeBasedSnapTolerance(e))
        }, Or.isValid = function(t, e, n, i) {
            return new Or(t, e, i).isValid(n)
        }, Tr.TOLERANCE.get = function() {
            return 1e-6
        }, Object.defineProperties(Or, Tr);
        var Pr = function eo(t) {
            this._geomFactory = null, this._skipEmpty = !1, this._inputGeoms = null, this._geomFactory = eo.extractFactory(t), this._inputGeoms = t
        };
        Pr.prototype.extractElements = function(t, e) {
            ...
            for (var t = new xt, e = this._inputGeoms.iterator(); e.hasNext();) {
                var n = e.next();
        ...
        var Rr = function() {
                ...
                var t = arguments[0];
                this._inputPolys = t, null === this._inputPolys && (this._inputPolys = new xt)
            },
            Dr = {
        ...
        Rr.prototype.reduceToGeometries = function(t) {
            for (var e = new xt, n = t.iterator(); n.hasNext();) {
                var i = n.next(),
                    r = null;
                O(i, Lt) ? r = this.unionTree(i) : i instanceof ht && (r = i), e.add(r)
            }
            return e
        }, Rr.prototype.extractByEnvelope = function(t, e, n) {
            for (var i = new xt, r = 0; r < e.getNumGeometries(); r++) {
                var o = e.getGeometryN(r);
                o.getEnvelopeInternal().intersects(t) ? i.add(o) : n.add(o)
            }
            return this._geomFactory.buildGeometry(i)
        }, Rr.prototype.unionOptimized = function(t, e) {
        ...
        }, Rr.prototype.union = function() {
            if (null === this._inputPolys) throw new Error("union() method cannot be called twice");
            if (this._inputPolys.isEmpty()) return null;
            this._geomFactory = this._inputPolys.iterator().next().getFactory();
            for (var t = new sn(Rr.STRTREE_NODE_CAPACITY), e = this._inputPolys.iterator(); e.hasNext();) {
                var n = e.next();
        ...
        }, Rr.prototype.binaryUnion = function() {
            if (1 === arguments.length) {
                var t = arguments[0];
            ...
            return Rr
        }, Rr.restrictToPolygons = function(t) {
            if (O(t, Qt)) return t;
            var e = xi.getPolygons(t);
            return 1 === e.size() ? e.get(0) : t.getFactory().createMultiPolygon(ye.toPolygonArray(e))
        }, Rr.getGeometry = function(t, e) {
            return e >= t.size() ? null : t.get(e)
        }, Rr.union = function(t) {
            return new Rr(t).union()
        ...
        Ar.prototype.interfaces_ = function() {
            ...
            if (t.isEmpty() || e.isEmpty()) {
                if (t.isEmpty() && e.isEmpty()) return Cr.createEmptyResult(Cr.UNION, t, e, t.getFactory());
                if (t.isEmpty()) return e.copy();
                if (e.isEmpty()) return t.copy()
            }
            return t.checkNotGeometryCollection(t), t.checkNotGeometryCollection(e), or.overlayOp(t, e, Cr.UNION)
        }, t.GeoJSONReader = xe, t.GeoJSONWriter = Ne, t.OverlayOp = Cr, t.UnionOp = Ar, t.BufferOp = di, Object.defineProperty(t, "__esModule", {
            value: !0
        })
    })
}, function(t, e, n) {
    ...
    function o(t) {
        var e, n, i, r, o, a, l = 0,
            h = t.length;
        if (h > 2) {
            for (a = 0; a < h; a++) a === h - 2 ? (i = h - 2, r = h - 1, o = 0) : a === h - 1 ? (i = h - 1, r = 0, o = 1) : (i = a, r = a + 1, o = a + 2), e = t[i], n = t[r], l += (s(t[o][0]) - s(e[0])) * Math.sin(s(n[1]));
            l = l * u * u / 2
        }
        return l
    }
    ...
    var a = n(6),
        u = 6378137;
    e.a = function(t) {
        return Object(a.b)(t, function(t, e) {
            return t + i(e)
        }, 0)
    }
}, function(t, e, n) {
    ...
    var i = {
        ...
        _onLayerDrag: function(t) {
            var e, n = t.latlng,
                i = {
                    lat: n.lat - this._tempDragCoord.lat,
                    lng: n.lng - this._tempDragCoord.lng
                },
                r = function(t) {
    ...
    })(n(1))["default"].LayerGroup = L.Class.extend({
        initialize: function(t) {
            var e = this;
    ...
    o["default"].Line = o["default"].extend({
        ...
        _handleLayerStyle: function(t) {
            ...
            if (this.hasSelfIntersection()) {
                ...
                t ? (L.DomUtil.addClass(e, "leaflet-pm-invalid"), window.setTimeout(function() {
                    ...
                    intersection: (0, r["default"])(this._layer.toGeoJSON())
                })
        ...
        _initMarkers: function() {
            ...
            var i = function(e) {
                ...
                return e.map(function(i, r) {
                    var o;
                    return o = t.isPolygon() ? (r + 1) % e.length : r + 1, t._createMiddleMarker(n[r], n[o])
                }), n
            };
        ...
        _createMiddleMarker: function(t, e) {
            ...
            return r.setIcon(o), t._middleMarkerNext = r, e._middleMarkerPrev = r, r.on("click", function() {
                var i = L.divIcon({
                    className: "marker-icon"
                });
        ...
        _addMarker: function(t, e, n) {
            ...
            var i = t.getLatLng(),
                ...
                a = o.index,
                u = s > -1 ? r[s] : r,
                l = s > -1 ? this._markers[s] : this._markers;
        ...
        _onMarkerDrag: function(t) {
            ...
            if (!(-1 === this.findMarkerIndex(this._markers, e).index)) {
                ...
                var n = this.findMarkerIndex(this._markers, e),
                    i = n.ringIndex,
                    r = n.index,
                    o = i > -1 ? this._markers[i] : this._markers,
                    s = (r + 1) % o.length,
                    a = (r + o.length - 1) % o.length,
                    u = e.getLatLng(),
                    l = o[a].getLatLng(),
                    h = o[s].getLatLng();
                ...
                if (e._middleMarkerPrev) {
                    var p = this._calcMiddleLatLng(u, l);
    ...
    i["default"].Rectangle = i["default"].Poly.extend({
        _initMarkers: function() {
            var t = this._map,
                e = this._findCorners();
        ...
        _adjustAdjacentMarkers: function(t) {
            if (t && t.getLatLng && t._oppositeCornerLatLng) {
                ...
                2 == i.length && this._cornerMarkers.forEach(function(t) {
                    var o = t.getLatLng();
                    o.equals(e) || o.equals(n) || (t.setLatLng(i[r]), r += 1)
                })
