...
<div id="fondo">
    <div class="wrapper" style="background-image: url('<?php echo base_url();?>_assets/img/background-login.jpg');">
        <div id="formContent" class="text-center">  
            <!-- Titulos -->
            <h5 class="titulo text-center">Perfil</h5>
            <!-- Logo -->
            <div class="logo ">
                <img src="<?php echo base_url();?>_assets/img/login_logo.png" class="img-fluid" alt="Logo" width="150"/>
            </div>
            <div class="col-10 col-md-9" style="margin-left: auto; margin-right: auto">
              <form id="loginform" action="index.php/Login/ingresar"  method="POST">
                      ...
                      <div class="md-form form-group mt-5">
                          <button id="btn-guardar" type="submit" class="btn btn-secondary">Cancelar</button>
                          <button id="btn-cancelar" type="submit" class="btn btn-primary">Guardar</button>
                      </div>
            </form>
          </div>
          <!-- Material form group -->
