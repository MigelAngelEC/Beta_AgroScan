    ...
    <script type="text/javascript" src="<?php echo base_url();?>_assets/p_assets/js/LeafletJS.js"></script>
    
    <!-- Checkbox radiogroup -->
    <script type="text/javascript" src="<?php echo base_url();?>_assets/p_assets/js/checkBox_group.js"></script>
</body>
</html>
